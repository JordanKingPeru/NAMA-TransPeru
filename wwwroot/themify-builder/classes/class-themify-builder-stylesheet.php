	...
	*/
    private  static function reSaveData($data){
        foreach($data as &$r){
            ...
            $r['element_id'] = !isset($r['element_id'])?Themify_Builder_Model::generateID():Themify_Builder_Model::checkUniqId($r['element_id']);
            unset($r['row_order']);
            if (!empty($r['cols'])) {
                foreach($r['cols'] as &$c){
                    $c['element_id'] = !isset($c['element_id'])?Themify_Builder_Model::generateID():Themify_Builder_Model::checkUniqId($c['element_id']);
                    ...
                    if (!empty($c['modules'])) {
                        foreach($c['modules'] as &$m){
                            ...
                            $m['element_id'] = !isset($m['element_id'])?Themify_Builder_Model::generateID():Themify_Builder_Model::checkUniqId($m['element_id']);
                            unset($m['row_order']);
                            ...
                            if (!empty($m['cols'])) {
                                foreach ($m['cols'] as &$sub_col) {
                                    $sub_col['element_id'] = !isset($sub_col['element_id'])?Themify_Builder_Model::generateID():Themify_Builder_Model::checkUniqId($sub_col['element_id']);
                                    ...
                                    if (!empty($sub_col['modules'])) {
                                        foreach ($sub_col['modules'] as &$sub_m) {
                                            $sub_m['element_id'] = !isset($sub_m['element_id'])?Themify_Builder_Model::generateID():Themify_Builder_Model::checkUniqId($sub_m['element_id']);
