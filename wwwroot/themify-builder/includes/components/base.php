...
class Themify_Builder_Component_Base {
	...
	public static function add_inline_edit_fields($name,$condition=true,$haEditor=false,$repeat=false,$index=-1,$echo=true){
		if ($condition===true && (Themify_Builder::$frontedit_active === true || (class_exists('Tbp_Utils') && Tbp_Utils::$isActive===true))){
