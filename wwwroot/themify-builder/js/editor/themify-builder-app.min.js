...
$jscomp.polyfillIsolated=function(m,H,z,I){var w=m.split(".");m=1===w.length;I=w[0];I=!m&&I in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var v=0;v<w.length-1;v++){var t=w[v];if(!(t in I))return;I=I[t]}w=w[w.length-1];z=$jscomp.IS_SYMBOL_NATIVE&&"es6"===z?I[w]:null;H=H(z);null!=H&&(m?$jscomp.defineProperty($jscomp.polyfills,w,{configurable:!0,writable:!0,value:H}):H!==z&&(void 0===$jscomp.propertyToPolyfillSymbol[w]&&(z=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[w]=$jscomp.IS_SYMBOL_NATIVE?
...
$jscomp.polyfill("Promise.allSettled",function(m){function H(I){return{status:"fulfilled",value:I}}function z(I){return{status:"rejected",reason:I}}return m?m:function(I){var w=this;I=Array.from(I,function(v){return w.resolve(v).then(H,z)});return w.all(I)}},"es_2020","es3");
$jscomp.polyfill("String.prototype.replaceAll",function(m){return m?m:function(H,z){if(H instanceof RegExp&&!H.global)throw new TypeError("String.prototype.replaceAll called with a non-global RegExp argument.");return H instanceof RegExp?this.replace(H,z):this.replace(new RegExp(String(H).replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g,"\\$1").replace(/\x08/g,"\\x08"),"g"),z)}},"es_next","es3");var tb_app;
(function(m,H,z,I,w,v,t){const ba="undefined"!==typeof themifyScript&&themifyScript.is_fullSection;void 0===m.fn.themifySerializeObject&&(m.fn.themifySerializeObject=function(){for(var a={},b=this.length-1;-1<b;--b){var d=this[b].type;if(this[b].classList.contains("wp-editor-area")&&"undefined"!==typeof tinyMCE){var f=tinyMCE.get(this[b].id);f&&(this[b].value=f.getContent())}if(""!==this[b].value&&("text"===d||"number"===d||"radio"===d||"checkbox"===d||"textarea"===d||"select-one"===d||"hidden"===
d||"email"===d||"select"===d||"select-multiple"===d)&&(this[b].name||this[b].id)){f=this[b].name?this[b].name:this[b].id;var e=this[b].value;"radio"===d||"checkbox"===d?e=this[b].checked&&e:"select-multiple"===d&&(e=m(this[b]).val());void 0!==a[f]&&"radio"!==d?(!a[f].push&&(a[f]=[a[f]]),e&&a[f].push(e)):e&&(a[f]=e)}}return a});const c=tb_app={activeModel:null,Models:{},Collections:{},Mixins:{},Views:{Modules:{},Rows:{},SubRows:{},Columns:{}},Forms:{},Constructor:{},Utils:{},Instances:{Builder:{}}};
let Y={},S=null;c.builderIndex=0;c.mode="default";c.autoSaveCid=null;c.hasChanged=null;c.editing=!1;c.scrollTo=!1;c.eventName=!1;c.beforeEvent=!1;c.saving=!1;c.activeBreakPoint="desktop";c.zoomMeta={isActive:!1,size:100};c.isPreview=!1;c.clearOnModeChange=null;c.Models.Module=H.Model.extend({defaults:{element_id:null,elType:"module",mod_name:"",mod_settings:{}},initialize(){c.Models.Registry.register(this.cid,this);let a=this.get("element_id");a&&1!==Y[a]||(a=c.Utils.generateUniqueID(),this.set({element_id:a},
{silent:!0}));Y[a]=1},toRenderData(){const a=this.get("mod_name");return{icon:c.Utils.getIcon("ti-"+themifyBuilder.modules[a].icon).outerHTML,name:themifyBuilder.modules[a].name,slug:a,element_id:this.get("element_id"),excerpt:this.getExcerpt()}},getExcerpt(a){a=a||this.get("mod_settings");return this.limitString(a.content_text||a.content_box||a.plain_text||"",100)},limitString(a,b){let d="";""!==a&&(a=this.stripHtml(a).toString(),d=a.length>b?a.substr(0,b):a);return d},stripHtml(a){const b=v.createElement("div");
b.innerHTML=a;return b.textContent||b.innerText||""},setData(a){c.Utils.clearElementId([a]);a=c.Views.init_module(a);a.model.trigger("custom:change",a)},backendLivePreview(){m(".tb_element_cid_"+this.cid).find(".module_excerpt").text(this.getExcerpt())},getPreviewSettings(){return Object.assign({cid:this.cid},themifyBuilder.modules[this.get("mod_name")].defaults)},getIDattr(){let a=this.get("element_id");a||(a=c.Utils.generateUniqueID());return a}});c.Models.SubRow=H.Model.extend({defaults:{element_id:null,
elType:"subrow",gutter:"gutter-default",column_alignment:ba?"col_align_middle":"col_align_top",column_h:"",desktop_dir:"ltr",tablet_dir:"ltr",tablet_landscape_dir:"ltr",mobile_dir:"ltr",col_mobile:"-auto",col_tablet_landscape:"-auto",col_tablet:"-auto",cols:{},styling:{}},initialize(){c.Models.Registry.register(this.cid,this);let a=this.get("element_id");a&&1!==Y[a]||(a=c.Utils.generateUniqueID(),this.set({element_id:a},{silent:!0}));Y[a]=1},setData(a){c.Utils.clearElementId([a]);a=c.Views.init_subrow(a);
a.model.trigger("custom:change",a)}});c.Models.Column=H.Model.extend({defaults:{element_id:null,elType:"column",grid_class:"",component_name:"column",modules:{},styling:{}},initialize(){c.Models.Registry.register(this.cid,this);let a=this.get("element_id");a&&1!==Y[a]||(a=c.Utils.generateUniqueID(),this.set({element_id:a},{silent:!0}));Y[a]=1},setData(a){c.Utils.clearElementId([a]);a=c.Views.init_column(a);a.model.trigger("custom:change",a)}});c.Models.Row=H.Model.extend({defaults:{element_id:null,
elType:"row",gutter:"gutter-default",column_alignment:ba?"col_align_middle":"col_align_top",column_h:"",desktop_dir:"ltr",tablet_dir:"ltr",tablet_landscape_dir:"ltr",mobile_dir:"ltr",col_mobile:"-auto",col_tablet_landscape:"-auto",col_tablet:"-auto",cols:{},styling:{}},initialize(){c.Models.Registry.register(this.cid,this);let a=this.get("element_id");a&&1!==Y[a]||(a=c.Utils.generateUniqueID(),this.set({element_id:a},{silent:!0}));Y[a]=1},setData(a){c.Utils.clearElementId([a]);a=c.Views.init_row(a);
a.model.trigger("custom:change",a)}});c.Collections.Rows=H.Collection.extend({model:c.Models.Row});c.Models.Registry={items:{},register(a,b){this.items[a]=b},lookup(a){return this.items[a]||null},remove(a){this.items[a]=null;delete this.items[a]},destroy(){for(let a in this.items)this.items[a].destroy();this.items={}}};c.vent=Object.assign({},H.Events);c.Views.register_module=function(a){"default"!==c.mode&&(this.Modules[c.mode]=this.Modules.default.extend(a))};c.Views.init_module=function(a,b){if(void 0===
...
b=t.Clipboard.get(e);!1===g&&!1===b&&"column"===e&&(b=t.Clipboard.get("module"),e="module",h=b.mod_name);if(!1===b||!0===g&&"module"===e&&h!==b.mod_name)!0!==d&&t.alertWrongPaste();else{c.eventName="row";if(!0===g){const p=ThemifyStyles.getStyleOptions("module"===e?h:e);d="module"===e?"mod_settings":"styling";const l=this.getData(a,"column"===e?f.get("component_name"):e),q=function(n){if(-1!==n.indexOf("breakpoint_")||-1!==n.indexOf("_apply_all"))return!0;let r=-1!==n.indexOf("_color")?"color":-1!==
n.indexOf("_style")?"style":!1;if(!1!==r){if(r=n.replace("_"+r,"_width"),void 0!==p[r]&&"border"===p[r].type)return!0}else if(-1!==n.indexOf("_unit")){if(r=n.replace(/_unit$/ig,"",""),void 0!==p[r])return!0}else if(-1!==n.indexOf("_w")){if(r=n.replace(/_w$/ig,"",""),void 0!==p[r]&&"font_select"===p[r].type)return!0}else if(void 0!==p[n]&&"radio"===p[n].type)return!0;return!1};void 0===l[d]&&(l[d]={});for(var k in b[d])void 0!==p[k]||q(k)?(l[d][k]=b[d][k],void 0!==p[k]&&(!0===p[k].isFontColor&&void 0!==
b[d][p[k].g+"-gradient"]?l[d][p[k].g+"-gradient"]=b[d][p[k].g+"-gradient"]:(void 0!==p[k].posId&&void 0!==b[d][p[k].posId]&&(l[d][p[k].posId]=b[d][p[k].posId]),void 0!==p[k].repeatId&&void 0!==b[d][p[k].repeatId]&&(l[d][p[k].repeatId]=b[d][p[k].repeatId])))):delete b[d][k];void 0!==b.used_gs&&(l.used_gs=b.used_gs);b=l;delete b.element_id}if("column"===e){b.grid_class=c.Utils.filterClass(a.prop("class"));if(a.hasClass("first")||a.hasClass("last"))b.grid_class+=a.hasClass("first")?" first":" last";
k=a[0].style.width;b.grid_width=k?k.replace("%",""):null;b.component_name=f.get("component_name")}!1===g&&c.Utils.clearElementId([b]);c.hasChanged=!0;!1===g&&"module"===e&&"column"===f.get("elType")&&(f=c.Views.init_module({mod_name:h},!0),e=f.view.render().$el,a[0].getElementsByClassName("tb_holder")[0].appendChild(e[0]),f=f.model,a=e);c.beforeEvent=t.clone(a);f.setData(b);null!==c.activeModel&&t.Lightbox.close()}},importExport(a,b){const d=b.classList.contains("tb_import")?"import":"export",f=this,
e=this.$el,h=this.model;let g=h.get("elType");g="column"===g?h.get("component_name"):g;b=g.charAt(0).toUpperCase()+g.slice(1);const k="subrow"===g?"Sub-Row":"sub-column"===g?"Sub-Column":b;b={contructor:!0,loadMethod:"html",data:{component_form:{name:ThemifyConstructor.label[d+"_tab"].replace("%s",b),options:[{id:"tb_data_field",type:"textarea",label:ThemifyConstructor.label.import_label.replace("%s",k),help:ThemifyConstructor.label[d+"_data"].replace("%s",b),"class":"fullwidth",rows:13,readonly:"export"===
d?1:0}]}}};"import"===d&&(b.save={});t.Lightbox.$lightbox[0].style.display="none";t.Lightbox.open(b,function(){w.document.body.classList.add("tb_standalone_lightbox")},function(){const p=this.$lightbox;p.addClass("tb_import_export_lightbox");this.setStandAlone(a.clientX,a.clientY);if("import"===d)p.find(".builder_save_button").on("click.tb_import",function(l){l.preventDefault();l.stopPropagation();l=p.find("#tb_data_field").val();if(""===l)t.Lightbox.close();else{l=JSON.parse(l);if("column"===g&&
"sub-column"===l.component_name||"sub-column"===g&&"column"===l.component_name)l.component_name=g;if(l.component_name&&l.component_name===g){if("column"===g||"sub-column"===g){var q=e[0].closest(".module_column");const n=q.style.width,r=q.classList;l.grid_class=c.Utils.filterClass(q.className);if(r.contains("first")||r.contains("last"))l.grid_class+=r.contains("first")?" first":" last";l.grid_width=n?n.replace("%",""):null}c.eventName="row";c.hasChanged=!0;c.beforeEvent=t.clone(e);q=function(n){n=
c.Utils.clear(n);h.setData(n);t.Lightbox.close()};void 0!==l.used_gs?c.GS.setImport(l.used_gs,q,l):q(l)}else t.alertWrongPaste()}});else{let l=f.getData(e,g);l.component_name=g;const q=c.GS.findUsedItems(l);if(!1!==q){const n={};for(let r=q.length-1;-1<r;--r){let u=c.GS.styles[q[r]],x=m.extend(!0,{},u.data[0]);"row"===u.type||"subrow"===u.type?x=x.styling:void 0!==x.cols?(x=x.cols[0])&&(x="column"===u.type?x.styling:void 0!==x.modules?x.modules[0].mod_settings:void 0):x=void 0;void 0!==x&&0<Object.keys(x).length&&
(n[q[r]]={title:u.title,type:u.type,data:c.Utils.clear(x,!1)})}Object.keys(n).length&&(l.used_gs=n)}l=JSON.stringify(l);p.find("#tb_data_field").val(l).on("click",function(){m(this).trigger("focus").trigger("select")})}z.body.one("themify_builder_lightbox_close",function(){p.removeClass("tb_import_export_lightbox");w.document.body.classList.remove("tb_standalone_lightbox");"import"===d&&p.find(".builder_save_button").off("click.tb_import")})})},getData(a,b){var d={};switch(b){case "row":case "subrow":d=
c.Utils._getRowSettings(a.closest("."+("row"===b?"module_row":"active_subrow"))[0],b);break;case "module":d=c.Models.Registry.lookup(a.closest(".active_module").data("cid")).attributes;break;case "column":case "sub-column":a=a.closest(".module_column"),d=a.closest("column"===b?".module_row":".active_subrow"),d=c.Utils._getRowSettings(d[0],"column"===b?"row":"subrow").cols[a.index()]}return c.Utils.clear(d)},duplicate(a,b){a=this.$el;b=t.clone(a);null!==c.activeModel&&t.Lightbox.$lightbox.is(":visible")&&
ThemifyConstructor.saveComponent();a.removeClass("tb_element_cid_"+this.model.cid);b.hide().insertAfter(a);const d=this.getData(b,this.model.get("elType"));c.eventName="duplicate";c.beforeEvent=b;c.hasChanged=!0;this.model.setData(d);a.addClass("tb_element_cid_"+this.model.cid)},edit(a,b){if(c.isPreview)return!0;"breadcrumb"!==a?c.ActionBar.breadCrumbsPath.lightbox=null:a=null;let d=c.hasChanged=!1,f=t.Lightbox.$lightbox,e=this.model.get("elType"),h=!1,g="module"===e?this.model.get("mod_name"):e,
k=!1;if(null!==a){const p=b?b.classList:a.target,l=p.contains("tb_dragger");if(!0===l&&(!b.hasAttribute("data-v")||""===b.getAttribute("data-v")))return;"dblclick"===a.type&&this.model.cid!==c.autoSaveCid&&c.ActionBar.clear();k=l||p.contains("tb_styling");if(!0===k)this.model.set({styleClicked:!0},{silent:!0}),!0===l&&(h=function(q){var n=p.contains("tb_dragger_padding")?"p":"m";n=ThemifyConstructor.label[n];const r=q.getElementsByClassName("tb_style_toggle");for(let u=r.length-1;-1<u;--u)if(r[u].textContent===
n){r[u].classList.contains("tb_closed")&&r[u].click();setTimeout(function(){r[u].closest(".tf_scrollbar").scrollTop=r[u].offsetTop},10);break}});else if(p.contains("tb_visibility_component"))d=!0,this.model.set({visibileClicked:!0},{silent:!0});else if(!0===(p.contains("tb_swap")?!1:"layout-part"===g?!0:z.body.triggerHandler("tb_edit_"+g,[a,this.el,this.model]))&&"visual"===c.mode&&!c.Forms.LayoutPart.id&&("dblclick"===a.type||p.contains("tb_edit"))){c.activeModel=this.model;c.Forms.LayoutPart.edit(this.el);
return}}null!==c.activeModel&&null!==c.autoSaveCid&&this.model.cid!==c.autoSaveCid&&ThemifyConstructor.saveComponent(!0);c.activeModel=this.model;if(c.autoSaveCid===this.model.cid){a=null;if(!0===k)a=f.find('a[href="#tb_options_styling"]'),this.model.unset("styleClicked",{silent:!0});else if(!0===d)a=f.find('a[href="#tb_options_visibility"]'),this.model.unset("visibileClicked",{silent:!0});else if("module"===e||"row"===e)a=f.find('a[href="#tb_options_setting"]');null!==a&&0<a.length&&(a[0].click(),
!1!==h&&!0===k&&h(t.Lightbox.$lightbox[0].querySelector("#tb_lightbox_container")))}else t.Lightbox.open({loadMethod:"inline",templateID:g},!1,h),!1===c.GS.isGSPage&&(c.ActionBar.hideContextMenu(),("row"!==g||"row"===g&&null!==c.ActionBar.breadCrumbsPath.lightbox)&&t.Lightbox.$lightbox[0].getElementsByClassName("tb_action_breadcrumb")[0].appendChild(c.ActionBar.getBreadCrumbs(c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_cid_"+this.model.cid)[0])))},delete(a,b,d){let f=
this.$el,e=this.model;b=a=e.cid;let h=e.get("elType");if(!0===d||confirm(themifyBuilder.i18n[h+"DeleteConfirm"])){d=f.closest(".module_row");var g="row",k="",p,l={};"row"===h?(l.pos_cid=d.next(".module_row"),l.pos="before",0===l.pos_cid.length&&(l.pos="after",l.pos_cid=d.prev(".module_row")),g="delete_row",l.pos_cid=l.pos_cid.data("cid")):a=d.data("cid");d=t.clone(d);"row"!==h&&(p=f.closest(".active_subrow"));e.destroy();p&&0<p.length&&0===p.find(".active_module").length&&p.addClass("tb_row_empty");
"row"!==h&&(k=m(".tb_element_cid_"+a),p=k.closest(".module_row"),0===p.find(".active_module").length&&p.addClass("tb_row_empty"));c.hasChanged=!0;c.undoManager.push(a,d,k,g,l);c.toolbar.pageBreakModule.countModules();c.activeModel&&c.activeModel.cid===b&&t.Lightbox.$lightbox.find(".tb_close_lightbox")[0].click()}},save(a){c.activeModel&&null!==c.autoSaveCid&&ThemifyConstructor.saveComponent(!0);const b=this.model.get("elType"),d={contructor:!0,loadMethod:"html",save:{done:"save"},data:{}},f=this.model.cid;
d.data["s"+b]={options:[{id:"item_title_field",type:"text",label:ThemifyConstructor.label.title},{id:"item_layout_save",type:"checkbox",label:"",options:[{name:"layout_part",value:ThemifyConstructor.label.slayout_part}],new_line:!1,after:"",help:'Any changes made to a Layout Part are saved and reflected everywhere else they are being used (<a href="https://themify.me/docs/builder#layout-parts" target="_blank">learn more</a>)'}]};t.Lightbox.$lightbox[0].style.display="none";t.Lightbox.open(d,function(){w.document.body.classList.add("tb_standalone_lightbox")},
...
{action:"tb_save_custom_item",item:JSON.stringify(l),tb_load_nonce:themifyBuilder.tb_load_nonce,postid:q,type:b});var n=k.item_layout_save;p=c.GS.findUsedItems(l);!1!==p&&(k.usedGS=p);m.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:k,success(r){if("success"===r.status){const u=function(x){m("#tb_module_panel",w.document).find(".tb_module_panel_search_text").val("");if(n){c.hasChanged=!0;var y={mod_name:"layout-part",mod_settings:{selected_layout_part:x.post_name}};delete x.status;
...
3)&&(m(this).off("ajaxComplete",G),A=c.liveStylingInstance.$liveStyledElmt,"row"===b&&(A=A.closest(".module_row")),c.undoManager.push(E.$el.data("cid"),C,A,"row"))};m(v).ajaxComplete(G);y.trigger("custom:preview:refresh",y.get("mod_settings"))}else A=E.el,c.undoManager.push(E.$el.data("cid"),C,A,"row")}if(!0===c.toolbar.libraryItems.is_init){B=m(".tb_library_item_list");x=c.toolbar.libraryItems.template([x]);"visual"===c.mode&&(B=B.add(c.toolbar.$el.find(".tb_library_item_list")));B=B.get();for(let A=
0,E=B.length;A<E;++A)B[A].insertAdjacentHTML("afterbegin",x),B[A].previousElementSibling.getElementsByClassName("current")[0].click()}t.showLoader("hide");t.Lightbox.close()};n?(ThemifyStyles.builder_id=r.id,c.Utils.saveCss([l],"",r.id).done(function(){ThemifyStyles.builder_id=q;u(r)})):u(r)}else alert(r.msg)}})}};h.addClass("tb_save_module_lightbox");this.setStandAlone(a.clientX,a.clientY);h.on("click.saveLayout",".builder_save_button",g).on("keypress.saveLayout","input",g);z.body.one("themify_builder_lightbox_close",
...
c.Views.init_subrow(b))&&d.appendChild(b.view.render().el)}"sub-column"===this.model.get("component_name")&&d.classList.add("tb_subrow_holder")}return this}});c.Views.SubRows["default"]=c.Views.BaseElement.extend({tagName:"div",attributes(){return{"class":"active_module active_subrow tb_element_cid_"+this.model.cid,"data-cid":this.model.cid,draggable:!0}},template:wp.template("builder_subrow_item"),render(){const a=this.model.get("cols"),b=Object.keys(a).length;this.el.innerHTML=this.template({element_id:this.model.get("element_id")});
if(0<b){const d=this.el.getElementsByClassName("subrow_inner")[0];let f=!1;for(let e=0;e<=b;++e)void 0!==a[e]&&null!==a[e]&&(a[e].component_name="sub-column",d.appendChild(c.Views.init_column(a[e]).view.render().el),!1===f&&void 0!==a[e].modules&&0<a[e].modules.length&&(f=!0));!1===f&&this.el.classList.add("tb_row_empty")}c.Utils.selectedGridMenu(this.el,"subrow");c.Utils.visibilityLabel(this.el,this.model);return this}});c.Views.Rows["default"]=c.Views.BaseElement.extend({tagName:"div",attributes(){const a=
this.model.get("styling"),b={"class":"module_row themify_builder_row tb_element_cid_"+this.model.cid+" tf_clearfix tf_box tb_"+this.model.get("element_id"),"data-cid":this.model.cid,draggable:!0};null!==a&&(void 0!==a.custom_css_row&&""!==a.custom_css_row&&(b["class"]+=" "+a.custom_css_row),void 0!==a.custom_css_id&&""!==a.custom_css_id&&(b.id=a.custom_css_id),"fullwidth-content"===a.row_width&&(b["class"]+=" fullwidth"));return b},render(){const a=this.model.get("cols"),b=Object.keys(a).length;let d=
!1;this.el.innerHTML=t.templateCache.get("tmpl-builder_row_item");const f=this.el.getElementsByClassName("row_inner")[0];if(0<b)for(let e=0;e<=b;++e)void 0!==a[e]&&null!==a[e]&&(a[e].component_name="column",f.appendChild(c.Views.init_column(a[e]).view.render().el),!1===d&&void 0!==a[e].modules&&(0<a[e].modules.length||"object"===typeof a[e].modules&&0<Object.keys(a[e].modules).length)&&(d=!0));else c.Utils._addNewColumn({newclass:"col-full",component:"column"},f);!1===d&&this.el.classList.add("tb_row_empty");
...
l=k.parentNode,q=k.classList.contains("tb_drag_right")?"w":"e",n=a.clientX,r=v.createElement("div"),u=v.createElement("div"),x=t.clone(l.closest(".module_row")),y=l.parentNode;b=y.classList.contains("direction-rtl");var B=y.offsetWidth;r.className=u.className="tb_grid_drag_tooltip";k.classList.add("tb_drag_grid_current");l.classList.add("tb_element_clicked");g.add("tb_start_animate","tb_drag_grid_start");if("w"===q){r.className+=" tb_grid_drag_right_tooltip";u.className+=" tb_grid_drag_left_tooltip";
var A=b?l.previousElementSibling:l.nextElementSibling;var E=l.offsetWidth;var C=E+k.offsetWidth}else r.className+=" tb_grid_drag_left_tooltip",u.className+=" tb_grid_drag_right_tooltip",A=b?l.nextElementSibling:l.previousElementSibling,E=C=l.offsetWidth;l.style.willChange=A.style.willChange="width";var G=function(O){O.stopImmediatePropagation();e&&cancelAnimationFrame(e);e=requestAnimationFrame(function(){h=!0;var J=parseInt(O.clientX)-n;J=C+("e"===q?-J:J);const L=parseFloat(100*J/B).toFixed(2);if(5<=
L&&100>L){let N=K;N+="w"===q?-(J-E):E-J;const R=parseFloat(100*N/B).toFixed(2);5<R&&100>R&&(A.style.width=N+"px",l.style.width=J+"px",r.textContent=L+"%",u.textContent=R+"%")}})};v.addEventListener(p.mouseup,function(O){O.stopImmediatePropagation();this.removeEventListener(p.mousemove,G,{passive:!0});e&&cancelAnimationFrame(e);l.style.willChange=A.style.willChange="";requestAnimationFrame(function(){h&&(l.style.width=parseFloat(r.textContent).toFixed(2)+"%");r.remove();u.remove();l.classList.remove("tb_element_clicked");
...
L=y.children,N=3.2,R=J["default"];y.classList.contains("gutter-narrow")?(R=J.narrow,N/=2):y.classList.contains("gutter-none")&&(R=J.none,N=0);J=N*(L.length-1);for(N=L.length-1;-1<N;--N)if(L[N]!==A){var P=L[N].style.width;P?P=parseFloat(P):(P=c.Utils.filterClass(L[N].className),P=R[P]);J+=P}A.style.width=100-J+"%";c.Utils.setCompactMode([l,A]);L=m(l.closest(".module_row"));R=!0===c.hasChanged;c.hasChanged=!0;c.undoManager.push(L.data("cid"),x,L,"row");c.hasChanged=R;z.body.triggerHandler("tb_grid_changed",
[L])}h=e=K=A=E=C=null})},{once:!0,passive:!0});if(A){var K=parseInt(A.offsetWidth)-2;k.appendChild(r);k.appendChild(u);v.addEventListener(p.mousemove,G,{passive:!0})}}},updateModuleSort(a){if(!0!==c.GS.isGSPage){var b=this,d=c.Utils.getMouseEvents(),f;a.addEventListener(d.mousedown,function(e){1!==e.which||e.target.closest(".tb_dragger,.tb_disable_sorting,.tb_editor_on")?f=null:(f=e.target,f.classList.contains("tb_grid_drag")&&b.columnDrag(e))},{passive:!0});a.addEventListener("dragstart",function(e){let h=
...
"",F.classList.contains("tb_holder")?F.appendChild(q):"top"===M?F.before(q):F.after(q)));A=F}}},ca=function(D){D.stopImmediatePropagation();c.ActionBar.clear();c.ActionBar.disable=!0;c.ActionBar.hoverCid=null;c.toolbar.common.hide(!0);this.classList.add("tb_draggable_item");R();p&&(p.style.top=D.clientY+"px")},U=function(D){D.stopImmediatePropagation()},ea=function(D){D.target&&(D.preventDefault(),D.stopImmediatePropagation());E=c.hasChanged=!0;h.classList.remove("tb_draggable_item");var M=!0,F=D.target?
D.target:D;F.classList.contains("module_column")?F=F.querySelector("[data-pos]"):F.classList.contains("tb_dragger")&&(F=F.closest("[draggable]"));if(F===q||F.classList.contains("tb_sortable_placeholder"))F=F.closest(".tb_active_builder").querySelector("[data-pos]"),F.classList.contains("tb_sortable_placeholder")&&(F=F.closest(".tb_holder"));q&&q.remove();if(F&&("module"!==n||!F.classList.contains("module_row"))){D=u?h:h.cloneNode(!0);var T=h.closest(".active_subrow"),V=h.closest(".module_row");N&&
(u=m(h).next(".module_row"),0===u.length&&(u=m(h).prev(".module_row"),M=!1),u=u.data("cid"));if(F.classList.contains("tb_holder"))F.appendChild(D);else{const Q="top"===F.getAttribute("data-pos")?F:F.nextElementSibling;F.parentNode.insertBefore(D,Q)}var X=m(D);if(g)if("visual"===c.mode&&("desktop"===c.activeBreakPoint?m("html,body"):m("body",w.document)).scrollTop(m(h).offset().top),N)T=m(h).next(".module_row"),V=!0,0===T.length&&(T=m(h).prev(".module_row"),M=V=!1),T=T.data("cid"),c.undoManager.push(h.dataset.cid,
null,null,"row_sort",{bnext:M,before:u,anext:V,after:T});else{if(k.contains("predesigned_row")||k.contains("tb_page_break_module")||"row"===h.dataset.type)"row"===h.dataset.type?c.toolbar.libraryItems.get(h.dataset.id,"row",function(Q){if(!Array.isArray(Q)){Q=Array(Q);const da=c.GS.findUsedItems(Q);!1!==da&&da.length&&(Q[0].used_gs=da)}b.rowDrop(Q,X)}):k.contains("tb_page_break_module")?(b.rowDrop(c.toolbar.pageBreakModule.get(),X),c.toolbar.pageBreakModule.countModules()):c.toolbar.preDesignedRows.get(h.dataset.slug,
function(Q){b.rowDrop(Q,X)})}else M=F.closest(".module_row"),"module"===n&&((F=F.closest(".tb_row_empty"))&&F.classList.remove("tb_row_empty"),M.classList.remove("tb_row_empty"),u&&(T&&T.classList.toggle("tb_row_empty",!T.querySelector(".active_module")),V&&V.classList.toggle("tb_row_empty",!V.querySelector(".active_module")))),u?c.undoManager.push(D.dataset.cid,u,M,"sort",{before:u.dataset.cid,after:M.dataset.cid}):b.moduleDrop(m(D),!1,t.clone(M));z.body.triggerHandler("tb_"+n+"_sort",[D])}};L.className=
"tb_sortable_helper tf_box tf_overflow";u&&(u=t.clone(u)[0]);k.contains("active_subrow")&&(r+=" tb_drag_subrow");if(N){p=L.cloneNode();L.style.opacity=0;if("visual"!==c.mode){var W=h.getBoundingClientRect();p.style.width=W.width+"px";p.style.left=W.left+"px"}v.body.appendChild(p);l=p.offsetHeight/2}else if("module"===n)if(k.contains("active_subrow"))L.innerHTML="Subrow";else{W=h.getAttribute("data-module-slug");if(!W){var aa=c.Models.Registry.lookup(h.getAttribute("data-cid"));aa&&"module"===aa.get("elType")&&
(W=aa.get("mod_name"))}if(W&&themifyBuilder.modules[W]){aa=themifyBuilder.modules[W].icon;const D=v.createElement("span");D.textContent=themifyBuilder.modules[W].name;D.className="tf_vmiddle";aa&&L.appendChild(c.Utils.getIcon("ti-"+aa));L.appendChild(D)}}else"column"===n?(L.className+=" "+h.className,L.innerHTML='<div class="tb_row_grid_title"></div>'):"row"===n&&(k.contains("tb_page_break_module")||k.contains("predesigned_row"))&&(W=k.contains("tb_page_break_module")?"tb_page_break_title":"tb_predesigned_rows_title",
L.textContent=h.getElementsByClassName(W)[0].textContent);if("visual"!==c.mode||g)q=v.createElement("div"),q.className="tb_sortable_placeholder tf_rel tf_w";v.body.appendChild(L);e.dataTransfer.setDragImage(L,L.offsetWidth/2+2,L.offsetHeight/2);h.addEventListener("dragend",function(D){D.stopImmediatePropagation();z.body[0].removeEventListener("dragover",Z);J.removeEventListener("drop",ea,{once:!0});J.removeEventListener("mousemove",U,{passive:!0});J.removeEventListener("mouseover",U,{passive:!0});
J.removeEventListener("mouseout",U,{passive:!0});J.removeEventListener("mouseenter",U,{passive:!0});J.removeEventListener("mouseleave",U,{passive:!0});this.removeEventListener("drag",ca,{once:!0,passive:!0});E||(D=J.querySelector("[data-pos]"))&&ea(D);L.remove();N&&p.remove();q&&q.remove();D=v.querySelectorAll("[data-pos]");for(let M=D.length-1;-1<M;--M)D[M].removeAttribute("data-pos");this.classList.remove("tb_draggable_item");R(!0);"visual"!==c.mode&&m(".is-drop-target").removeClass("is-drop-target");
c.ActionBar.disable=q=E=f=h=k=A=L=p=l=x=J=B=y=r=n=u=null;c.ActionBar.clear()},{once:!0,passive:!0});h.addEventListener("drag",ca,{once:!0,passive:!0});J.addEventListener("drop",ea,{once:!0});z.body[0].addEventListener("dragover",Z);J.addEventListener("mousemove",U,{passive:!0});J.addEventListener("mouseover",U,{passive:!0});J.addEventListener("mouseout",U,{passive:!0});J.addEventListener("mouseenter",U,{passive:!0});J.addEventListener("mouseleave",U,{passive:!0})})}},subRowDrop(a,b){c.ActionBar.clear();
...
a.replaceWith(q.el);g?c.activeModel=l.model:l.model.trigger("edit",null);c.hasChanged=!0;if("visual"===c.mode&&"layout-part"!==l.model.get("mod_name")&&1<=Object.keys(n).length){var u=n.cid;"part"===h||"ajax"===a.data("type")?(r=!0,l.model.trigger("custom:preview:refresh",n)):"module"!==h?l.model.trigger("custom:preview:live",n):c.Utils.runJs(q.$el,"module")}g&&(r&&(n=l.view.$el.find(".tb_preview_component").detach(),l.view.el.prepend(n)),d&&(u=q.$el.closest(".module_row"),u.removeClass("tb_row_empty").find(".tb_module_dragging_helper").remove(),
q.$el.closest(".active_subrow").removeClass("tb_row_empty"),n=d[0].getElementsByClassName("tb_library_item"),n[0]&&n[0].remove(),c.undoManager.push(u.data("cid"),d,u,"row"),u=u.data("cid"),c.Instances.Builder[c.builderIndex].removeLayoutButton(),c.activeModel=null),c.Utils.calculateHeight());c.Utils.scrollToDropped(null,u)}const l=c.Views.init_module(k,!0),q=l.view.render();"visual"===c.mode&&g?(k=[],k[l.model.cid]=1,c.bootstrap(k,p)):p(!0);return q}c.ActionBar.clear();const e={mod_name:a.data("module-slug")},
...
!1===d))));!0!==this.isFullWidth&&(b=null!==b?b.parentNode.closest(".module_column"):a.closest(".module_column"),!1!==this.isFullWidth&&(a=null!==b?b.closest(".module_row"):a.closest(".module_row"),null!==a&&(this.isFullWidth=a.offsetWidth<v.body.clientWidth,v.body.classList.toggle("tb_page_row_fullwidth",!this.isFullWidth))),null!==b&&null!==b.parentNode.parentNode.closest(".fullwidth")&&(a=b.getElementsByClassName("tb_column_action")[0],void 0!==a&&a.getBoundingClientRect().right>=v.body.clientWidth&&
...
"visual"===c.mode&&v.addEventListener("keydown",this.keypres.bind(this)))},push(a,b,d,f,e){c.hasChanged&&(c.editing=!1,d&&d instanceof HTMLElement&&(d=t.clone(d)),"visual"!==c.mode||"duplicate"!==f&&"sort"!==f||z.trigger("tfsmartresize"),this.stack.splice(this.index+1,this.stack.length-this.index),this.stack.push({cid:a,type:f,data:e,before:b,after:d}),this.index=this.stack.length-1,this.updateUndoBtns(),"visual"===c.mode&&(c.Forms.LayoutPart.isSaved=null,z.body.triggerHandler("builder_dom_changed",
[f])))},set(a){let b=a[0].querySelectorAll("[data-cid]");b=Array.prototype.slice.call(b);b.unshift(a[0]);for(a=b.length-1;-1<a;--a){let d=c.Models.Registry.lookup(b[a].getAttribute("data-cid"));d&&d.trigger("change:view",b[a])}},doScroll(a){return a},keypres(a){if(!0===a.ctrlKey||!0===a.metaKey){const b=v.activeElement.tagName,d=w.document.activeElement.tagName,f=a.which;"INPUT"!==b&&"TEXTAREA"!==b&&"INPUT"!==d&&"TEXTAREA"!==d&&(89===f||90===f&&!0===a.shiftKey?(a.preventDefault(),this.hasRedo()&&
this.changes(!1)):90===f&&(a.preventDefault(),this.hasUndo()&&this.changes(!0)))}},changes(a){c.ActionBar.clearClicked();var b=a?0:1;if(null!==c.activeModel&&("visual"!==c.mode||!v.activeElement.contentEditable&&c.liveStylingInstance.$liveStyledElmt[0].contains(v.activeElement))){if(!0===c.hasChanged){ThemifyConstructor.saveComponent(!1);m(this.btnUndo).triggerHandler("click");return}t.Lightbox.close()}b=this.stack[this.index+b];if(void 0!==b){this.is_working=!0;let l="",q=b.type;var d=m(".tb_element_cid_"+
...
this.doScroll(d),this.set(l),d.replaceWith(l),f=l.closest(".module_row")),f.toggleClass("tb_row_empty",0===f.find(".active_module").length),f=null;else{this.doScroll(d);h={};a?(l="string"===typeof b.before?b.before:t.clone(b.before),h[e]=b.data.bsettings):(l="string"===typeof b.after?b.after:t.clone(b.after),h[e]=b.data.asettings);if("string"===typeof l){var g=v.createElement("div");g.outerHTML=l;l=g.firstChild}if("visual"===c.mode){g=m.extend(!0,{},b.data.styles);for(var k in g){var p=ThemifyStyles.getSheet(k);
p=p.cssRules?p.cssRules:p.rules;for(let r in g[k])if(p[r])for(let u in g[k][r])p[r].style["backgroundClip"===u||"background-clip"===u?"WebkitBackgroundClip":u]=a?g[k][r][u].b:g[k][r][u].a}k=c.activeModel;e=void 0!==h[e][c.GS.key]?h[e][c.GS.key].split(" "):[];c.activeModel=f;c.GS.liveInstance=null;c.GS.generateValues(null,e,!0);c.activeModel=k;c.GS.liveInstance=null}f.set(h,{silent:!0});this.set(l);d.replaceWith(l)}}else if("inline"===q)b.data.innerHTML=a?b.before:b.after,z.triggerEvent(b.data,"change");
else if("predesign"===q)if(d=b.data.rows,a){this.doScroll(m(".tb_element_cid_"+d[0].data("cid")));for(let r=0,u=d.length;r<u;++r)m(".tb_element_cid_"+d[r].data("cid")).remove()}else{d=v.createDocumentFragment();f=[];for(let r=0,u=f.length;r<u;++r)e=t.clone(f[r]),d.appendChild(e[0]),f.push(e);!1!==b.data.prev?this.doScroll(m(".tb_element_cid_"+b.data.prev)).after(d):this.doScroll("visual"===c.mode?m("#themify_builder_content-"+b.data.bid):m("#tb_row_wrapper")).prepend(d);for(let r=0,u=f.length;r<u;++r)this.set(f[r]),
...
0,q=h.length;l<q;++l)void 0===b[h[l]]&&(b[h[l]]=v.createDocumentFragment()),b[h[l]].appendChild(e.cloneNode(!0))}d=this.el.getElementsByClassName("tb_module_category_content");for(f=d.length-1;-1<f;--f)if(e=d[f].getAttribute("data-category"))void 0!==b[e]?d[f].appendChild(b[e]):d[f].parentNode.style.display="none";"visual"===c.mode&&w.document.body.appendChild(this.el);b=function(){a.Panel.init();c.undoManager.init();a.preDesignedRows.init();a.libraryItems.init();a.common.init();a.darkMode();"visual"===
c.mode&&a.inlineEditorMode();setTimeout(function(){a.setMode();a.help.init();setTimeout(function(){a.Revisions.init();if("visual"===c.mode){const g=v.createElement("div");for(let k=6;1<k;--k){let p=v.createElement("div");p.className+="tb_row_grid tb_row_grid_"+k;p.innerHTML='<div class="tb_row_grid_title"></div>';g.appendChild(p)}g.className="tf_abs";g.style.visibility="hidden";v.body.appendChild(g);setTimeout(function(){g.remove()},500);a.$el.on("click",".tb_favorite",a.toggleFavoriteModule);a.unload()}z.body.on("click",
...
800);a.draggable();"true"===localStorage.getItem("tb_panel_closed")?a.closeFloat():a.Panel.setFocus()};if("visual"===c.mode)w.jQuery("body").one("themify_builder_ready",b);else b()},setMode(){localStorage.getItem("tb_mode")?c.ActionBar.isHoverMode=null:(c.ActionBar.isHoverMode=!0,this.el.getElementsByClassName("tb_change_mode")[0].getElementsByClassName("tb-checkbox")[0].checked=!0);!0===c.ActionBar.isInit&&c.ActionBar.changeMode()},darkMode(){localStorage.getItem("tb_dark_mode")?(c.ActionBar.darkMode=
...
n=parseInt(m(a).css("max-width")),r=this.dataset.axis,u=parseInt(a.offsetHeight,10),x=parseInt(a.offsetWidth,10),y=h.touches?h.touches[0].clientX:h.clientX,B=h.touches?h.touches[0].clientY:h.clientY,A=function(E){E.stopImmediatePropagation();k&&cancelAnimationFrame(k);k=requestAnimationFrame(function(){var C=E.touches?E.touches[0].clientX:E.clientX;var G=E.touches?E.touches[0].clientY:E.clientY;if("w"===r)C=y+x-C,C>n&&(C=n),C>=q&&C<=n&&(G=a.style.width,a.style.width=C+"px",a.style.left=parseInt(a.style.left)+
parseInt(G)-C+"px");else{G="-y"===r||"ne"===r||"nw"===r?B+u-G:u+G-B;C="sw"===r||"nw"===r?y+x-C:x+C-y;C>n&&(C=n);if(("se"===r||"x"===r||"sw"===r||"nw"===r||"ne"===r)&&C>=q&&C<=n){const K=a.style.width;a.style.width=C+"px";if("sw"===r||"nw"===r)a.style.left=parseInt(a.style.left)+parseInt(K)-C+"px"}if(("se"===r||"y"===r||"-y"===r||"sw"===r||"nw"===r||"ne"===r)&&50<=G&&G<=l){if("-y"===r||"nw"===r||"ne"===r)a.style.top=parseInt(a.style.top)+parseInt(a.style.height)-G+"px";a.style.height=G+"px"}}"y"!==
...
draggable(){const a=this.el.querySelector("#tb_module_panel"),b=c.Utils.getMouseEvents(),d=this;if(!t.Lightbox.dockMode.get()){var f=this.getStorage();if(f){for(let e in f)a.style[e]=f[e]+"px";f=f.width}else f=a.offsetWidth;f=this.getPanelClass(f);a.classList.add("tb_panel_floating",f);this._setResponsiveTabs(f)}a.getElementsByClassName("tb_drag_handle")[0].addEventListener(b.mousedown,function(e){if("touchstart"===e.type||1===e.which){e.stopImmediatePropagation();let h;const g=this.ownerDocument,
k=a.offsetLeft-(e.touches?e.touches[0].clientX:e.clientX),p=a.offsetTop-(e.touches?e.touches[0].clientY:e.clientY),l=function(n){n.stopImmediatePropagation();h&&cancelAnimationFrame(h);h=requestAnimationFrame(function(){const r=k+(n.touches?n.touches[0].clientX:n.clientX),u=p+(n.touches?n.touches[0].clientY:n.clientY);a.style.left=r+"px";a.style.top=u+"px";"visual"===c.mode&&t.Lightbox.dockMode.drag(n,r)})},q=function(n){g.body.classList.add("tb_start_animate","tb_move_drag","tb_panel_drag");d.setFloat();
t.Lightbox.dockMode.get()&&(t.Lightbox.dockMode.close(),setTimeout(function(){c.Utils._onResize(!0)},100))};g.addEventListener(b.mouseup,function(n){n.stopImmediatePropagation();this.removeEventListener(b.mousemove,q,{passive:!0,once:!0});this.removeEventListener(b.mousemove,l,{passive:!0});l(n);requestAnimationFrame(function(){g.body.classList.remove("tb_start_animate","tb_move_drag","tb_panel_drag");if(t.Lightbox.dockMode.get())d.removeFloat(),d._setResponsiveTabs(!1);else{const r=m(w).height()-
30,u=a.offsetTop;if(0>u||u>r)a.style.top=(0>u?0:r)+"px";d.updateStorage()}h=null})},{passive:!0,once:!0});g.addEventListener(b.mousemove,q,{passive:!0,once:!0});g.addEventListener(b.mousemove,l,{passive:!0})}},{passive:!0});this.resize()},minimize(a){a.preventDefault();a.stopPropagation();a=m(a.currentTarget).closest("#tb_module_panel");if(a.hasClass("tb_is_minimize")){a.removeClass("tb_is_minimize");const b=this.getStorage();a.css("height",b?b.height:"")}else a.addClass("tb_is_minimize")},import(a){a.preventDefault();
a.stopPropagation();var b=a.currentTarget.getAttribute("data-component");const d=w.document.getElementsByTagName("body")[0];var f={contructor:"file"!==b,dataType:"json",data:{action:"builder_import",type:b}};if("file"!==b||confirm(themifyBuilder.i18n.importFileConfirm))if("file"===b)a=w.document.getElementById("tb_import_filestb_plupload_browse_button"),null===a?(a=v.createElement("input"),b=v.createElement("div"),f=v.createElement("span"),b.id="tb_import_filestb_plupload_upload_ui",b.style.display=
"none",a.type="button",a.id="tb_import_filestb_plupload_browse_button",f.className="ajaxnonceplu",f.id=themifyBuilder.import_nonce,b.appendChild(a),b.appendChild(f),d.appendChild(b),c.Utils.builderPlupload("",a.parentNode)):a.click();else{t.Lightbox.$lightbox[0].style.display="none";const e=m(a.currentTarget.closest("ul")),h=e.offset();let g=h.top+e.height()-40;z.body.off("themify_builder_lightbox_close.import");e.addClass("tb_current_menu_selected");null!==c.Forms.LayoutPart.id&&(g-=I.pageYOffset+
60);t.Lightbox.open(f,function(){d.classList.add("tb_standalone_lightbox")},function(){this.$lightbox[0].classList.add("tb_import_post_lightbox");this.setStandAlone(h.left,g,!0);z.body.one("themify_builder_lightbox_close.import",function(){d.classList.remove("tb_standalone_lightbox");t.Lightbox.$lightbox[0].classList.remove("tb_import_post_lightbox");e.removeClass("tb_current_menu_selected")});m("#tb_submit_import_form",t.Lightbox.$lightbox).one("click",function(k){k.preventDefault();t.LiteLightbox.confirm(themifyBuilder.i18n.dialog_import_page_post,
function(p){m.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"builder_import_submit",nonce:themifyBuilder.tb_load_nonce,data:c.Forms.serialize("tb_options_import"),importType:"no"===p?"replace":"append",importTo:themifyBuilder.post_ID},beforeSend(l){t.showLoader("show")},success(l){void 0!==l.builder_data?c.Forms.reLoad(l,themifyBuilder.post_ID):t.showLoader("error");t.Lightbox.close()}})},{buttons:{no:{label:ThemifyConstructor.label.replace_builder},yes:{label:ThemifyConstructor.label.append_builder}}})})})}},
unload(){"visual"===c.mode&&v.head.insertAdjacentHTML("afterbegin",'<base target="_parent">');w.onbeforeunload=function(){return c.editing||!c.hasChanged&&!c.undoManager.hasUndo()?null:"Are you sure"}},panelClose(a){a.preventDefault();w.location.reload(!0)},loadLayout(a){a.preventDefault();a.stopPropagation();var b=this,d=w.document.body,f=m(a.currentTarget.closest("ul"));a=b.layoutsList?{loadMethod:"html",data:b.layoutsList}:{data:{action:"tb_load_layout"}};t.Lightbox.$lightbox[0].style.display=
"none";f.addClass("tb_current_menu_selected");z.body.off("themify_builder_lightbox_close.loadLayout");t.Lightbox.open(a,function(){d.classList.add("tb_load_layout_active","tb_standalone_lightbox")},function(){function e(){g.on("click.loadLayout",".layout_preview img",function(l){l.preventDefault();l.stopPropagation();const q=m(this).closest(".layout_preview");t.LiteLightbox.confirm(themifyBuilder.i18n.confirm_template_selected,function(n){const r=q.closest("ul").data("group"),u=function(x){if("no"!==
n){var y="visual"!==c.mode?v.getElementById("tb_row_wrapper"):v.getElementsByClassName("themify_builder_content-"+themifyBuilder.post_ID)[0];y=c.Mixins.Builder.toJSON(y);const B=[];for(let A in y)B.push(y[A]);for(let A in x)B.push(x[A]);x=B}!0!==b.is_set&&m.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"set_layout_action",nonce:themifyBuilder.tb_load_nonce,mode:"no"!==n?1:0,id:themifyBuilder.post_ID},success(){b.is_set=!0}});c.Forms.reLoad(x,themifyBuilder.post_ID);t.Lightbox.close()};
if("pre-designed"===r){t.showLoader("show");const x=q.data("slug"),y=themifyBuilder.paths.layout_template.replace("{SLUG}",x);if(!c.layouts_selected)c.layouts_selected={};else if(c.layouts_selected[x]){c.Utils.clearElementId(c.layouts_selected[x]);u(JSON.parse(c.layouts_selected[x]));return}m.get(y,null,null,"text").done(function(B){c.layouts_selected[x]=B;let A=JSON.parse(B);-1!==B.indexOf(c.GS.key)?m.getJSON(themifyBuilder.paths.layout_template.replace("{SLUG}",x+"-gs")).done(function(E){const C=
{};for(let G in E)void 0!==E[G]["class"]?C[E[G]["class"]]=E[G]:C[G]=E[G];c.GS.setImport(C,function(){u(A)},A)}).fail(function(E,C,G){u(A)}):u(A)}).fail(function(B,A,E){t.LiteLightbox.alert(ThemifyConstructor.label.layout_error.replace("{FILE}",y))}).always(function(){t.showLoader()})}else m.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_set_layout",nonce:themifyBuilder.tb_load_nonce,layout_slug:q.data("slug"),layout_group:r,mode:"no"!==n?1:0},beforeSend(){"visual"===
c.mode&&t.showLoader("show")},success(x){x.data?(x.gs&&(c.GS.styles=m.extend(!0,{},x.gs,c.GS.styles)),u(x.data),t.showLoader()):(t.showLoader("error"),alert(x.msg),t.Lightbox.close())}})},{buttons:{no:{label:ThemifyConstructor.label.layout_replace},yes:{label:ThemifyConstructor.label.layout_append}}})})}function h(){e();const l=k.find(".layout_preview_list");p.show().find("li").on("click",function(q){q.preventDefault();q.stopPropagation();this.classList.contains("current")||(q=l,this.classList.contains("all")||
(l.hide(),q=l.filter("[data-category"+(""!==themifyBuilder.paths.layouts_index?"*":"")+'="'+m(this).text()+'"]')),q.show(),m(this).addClass("current").siblings().removeClass("current"),p.parent().find(".tb_ui_dropdown_label").html(m(this).text()));c.Utils.hideOnClick(p)});p.find(".tb_selected_cat").click();g.find("#tb_layout_search").on("keyup",function(){let q=m.trim(m(this).val());var n=l;""!==q&&(n=p.find("li.all"),n[0].classList.contains("current")||n.click(),l.hide(),n=l.find(".layout_title:contains("+
q+")").closest(".layout_preview_list"));n.show()})[0].focus();z.body.one("themify_builder_lightbox_close.loadLayout",function(){g.off("click.loadLayout")[0].classList.remove("tb_predesigned_lightbox");k.find("#tb_layout_search").off("keyup");d.classList.remove("tb_load_layout_active","tb_standalone_lightbox");f.removeClass("tb_current_menu_selected")})}const g=this.$lightbox,k=g.find("#tb_tabs_pre-designed");if(0===k.length)d.classList.remove("tb_load_layout_active","tb_standalone_lightbox"),f.removeClass("tb_current_menu_selected"),
e();else{g[0].classList.add("tb_predesigned_lightbox");this.setStandAlone(w.innerWidth/2,(w.document.documentElement.clientHeight-g.height())/2,!0);var p=k.find(".tb_ui_dropdown_items");b.layoutsList?h():m.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_load_predesigned_layouts",nonce:themifyBuilder.tb_load_nonce,src:themifyBuilder.paths.layouts_index,id:themifyBuilder.post_ID},success(l){const q=JSON.parse(l.data);if(""===themifyBuilder.paths.layouts_index){var n=Object.keys(q);
c.layouts_selected={};for(var r=n.length-1;-1<r;--r)c.layouts_selected[q[n[r]].slug]=q[n[r]].data}l=l.selected;n={};r=v.createDocumentFragment();const u=v.createDocumentFragment();for(let A=0,E=q.length;A<E;++A){var x=v.createElement("li"),y=v.createElement("div");let C=v.createElement("div"),G=v.createElement("img"),K=v.createElement("div");var B=v.createElement("div");x.className="layout_preview_list";x.dataset.category=q[A].category;y.className="layout_preview";y.dataset.id=q[A].id;y.dataset.slug=
q[A].slug;C.className="thumbnail";G.src=q[A].thumbnail;G.alt=q[A].title;G.title=q[A].title;K.className="layout_action";B.className="layout_title";B.textContent=q[A].title;K.appendChild(B);void 0!==q[A].url&&(B=v.createElement("a"),B.className="layout-preview-link",B.href=q[A].url,B.target="_blank",B.title=themifyBuilder.i18n.preview,B.appendChild(c.Utils.getIcon("ti-search")),K.appendChild(B));C.appendChild(G);y.appendChild(C);y.appendChild(K);x.appendChild(y);r.appendChild(x);if(q[A].category){x=
String(q[A].category).split(",");for(let O=0,J=x.length;O<J;++O)""!==x[O]&&1!==n[x[O]]&&(y=v.createElement("li"),y.textContent=x[O],u.appendChild(y),n[x[O]]=1,x[O]===l&&(y.className="tb_selected_cat"))}}p[0].appendChild(u);k[0].getElementsByClassName("tb_layout_lists")[0].appendChild(r);b.layoutsList=g[0].getElementsByClassName("tb_options_tab_wrapper")[0].cloneNode(!0);h()},error(){t.LiteLightbox.alert(m("#tb_load_layout_error",k).show().text())}})}})},saveLayout(a){a.preventDefault();a.stopPropagation();
const b={contructor:!0,loadMethod:"html",save:{},data:{save_as_layout:{options:[{id:"layout_title_field",type:"text",label:ThemifyConstructor.label.title},{id:"layout_img_field",type:"image",label:ThemifyConstructor.label.image_preview},{id:"layout_img_field_id",type:"hidden"},{id:"postid",type:"hidden",value:themifyBuilder.post_ID}]}}},d=m(a.currentTarget.closest("ul"));d.addClass("tb_current_menu_selected");t.Lightbox.$lightbox[0].style.display="none";t.Lightbox.open(b,function(){w.document.body.classList.add("tb_standalone_lightbox")},
function(){const f=this.$lightbox;f.find(".builder_save_button").one("click",function(e){e.stopPropagation();e.preventDefault();m.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_save_custom_layout",nonce:themifyBuilder.tb_load_nonce,form_data:c.Forms.serialize(f[0])},beforeSend(){t.showLoader("show")},success(h){"success"===h.status?(t.showLoader(),t.Lightbox.close()):(t.showLoader("error"),alert(h.msg))}})});f.addClass("tb_savead_lightbox");this.setStandAlone(a.clientX,
a.clientY);z.body.one("themify_builder_lightbox_close",function(){f.removeClass("tb_savead_lightbox").find(".builder_save_button").off("click");w.document.body.classList.remove("tb_standalone_lightbox");d.removeClass("tb_current_menu_selected")})})},duplicate(a){a.preventDefault();a.stopPropagation();if(confirm(themifyBuilder.i18n.confirm_on_duplicate_page)){const b=this;c.Utils.saveBuilder(function(){b.Revisions.ajax({action:"tb_duplicate_page",tb_is_admin:"visual"!==c.mode},function(d){d&&(w.location.href=
m("<div/>").html(d).text())})})}},addCustomCSS(a){a.preventDefault();a.stopPropagation();null!==c.activeModel&&ThemifyConstructor.saveComponent(!0);null===S&&(S=themifyBuilder.custom_css,delete themifyBuilder.custom_css);S||(S="");const b={contructor:!0,loadMethod:"html",save:{},data:{css:{options:[{id:"custom_css",type:"textarea",rows:17,class:"fullwidth"},{id:"custom_css_m",type:"message",label:"",comment:ThemifyConstructor.label.cus_css_m},{id:"postid",type:"hidden",value:themifyBuilder.post_ID}]}}},
d=a.currentTarget;d.classList.add("tb_tooltip_active");t.Lightbox.$lightbox[0].style.display="none";w.document.body.classList.add("tb_standalone_lightbox");t.Lightbox.open(b,null,function(){const f=this.$lightbox,e=f[0].querySelector("#custom_css");e.value=S;"visual"===c.mode&&e.addEventListener("input",function(){let h=v.getElementById("tb_custom_css_tmp");null===h&&(h=v.createElement("style"),h.type="text/css",h.id="tb_custom_css_tmp",v.head.appendChild(h));h.innerHTML=this.value.trim()});f.addClass("tb_custom_css_lightbox").find(".builder_save_button").one("click",
function(h){h.stopImmediatePropagation();h.preventDefault();S=e.value.trim();t.Lightbox.close()});this.setStandAlone(a.clientX,a.clientY);z.body.one("themify_builder_lightbox_close",function(){S||(S="",d.classList.add("tb_tooltip_active"));const h=v.getElementById("tb_custom_css_tmp");h&&(h.innerHTML=S);w.document.body.classList.remove("tb_standalone_lightbox")})})},Revisions:{init(){c.toolbar.$el.find(".tb_toolbar_revision_btn").on("click",this.revision.bind(this))},revision(a){const b=a.target.classList;
if(b.contains("tb_toolbar_revision_btn"))null!==c.activeModel&&t.Lightbox.$lightbox.is(":visible")&&ThemifyConstructor.saveComponent();else if(b.contains("tb_save_revision")||b.contains("tb_load_revision"))a.preventDefault(),a.stopPropagation(),b.contains("tb_save_revision")?this.saveEvent():this.load(a)},load(a){const b=this,d=m("body",w.document),f=m(a.target.closest("ul")),e=f.offset();f.addClass("tb_current_menu_selected");t.Lightbox.$lightbox[0].style.display="none";z.body.off("themify_builder_lightbox_close.revisions");
b.ajax({action:"tb_load_revision_lists"},function(h){t.Lightbox.open({contructor:!0,loadMethod:"html",data:{revision:{html:m(h)[0]}}},function(){d.addClass("tb_standalone_lightbox")},function(){this.$lightbox[0].classList.add("tb_revision_lightbox");this.setStandAlone(e.left,e.top,!0);d.on("click.revision",".js-builder-restore-revision-btn",b.restore.bind(b)).on("click.revision",".js-builder-delete-revision-btn",b.delete.bind(b));z.body.one("themify_builder_lightbox_close.revisions",function(){f.removeClass("tb_current_menu_selected");
d.off(".revision").removeClass("tb_standalone_lightbox");t.Lightbox.$lightbox[0].classList.remove("tb_revision_lightbox")})})})},ajax(a,b){a=m.extend({},a,{tb_load_nonce:themifyBuilder.tb_load_nonce,postid:themifyBuilder.post_ID,sourceEditor:"visual"===c.mode?"frontend":"backend"});return m.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:a,beforeSend(){t.showLoader("show")},complete(){t.showLoader("hide")},success(d){"function"===typeof b&&b.call(this,d)}})},saveEvent(a){const b=this;t.LiteLightbox.prompt(themifyBuilder.i18n.enterRevComment,
function(d){null!==d&&b.saveRevision(d,a)})},saveRevision(a,b){const d=c.Utils.saveBuilder(null,!0);this.ajax({action:"tb_save_revision",rev_comment:a,data:JSON.stringify(c.Utils.clear(d.data)),postid:d.id},b)},restore(a){a.preventDefault();a.stopPropagation();const b=m(a.currentTarget).data("rev-id"),d=this,f=function(){d.ajax({action:"tb_restore_revision_page",revid:b},function(e){e.builder_data?(c.Forms.reLoad(e,themifyBuilder.post_ID),t.Lightbox.close()):(t.showLoader("error"),alert(e.data))})};
t.LiteLightbox.confirm(themifyBuilder.i18n.confirmRestoreRev,function(e){"yes"===e?d.saveEvent(f):f()},{buttons:{no:{label:ThemifyConstructor.label.save_no},yes:{label:ThemifyConstructor.label.save}}})},delete(a){a.preventDefault();a.stopPropagation();if(confirm(themifyBuilder.i18n.confirmDeleteRev)){var b=m(a.currentTarget);a=b.data("rev-id");this.ajax({action:"tb_delete_revision",revid:a},function(d){d.success?b.closest("li").remove():(t.showLoader("error"),alert(d.data))})}}},save(a){a.preventDefault();
a.stopPropagation();const b=a.currentTarget.closest(".tb_toolbar_backend_edit")?a.currentTarget.getAttribute("href"):!1;themifyBuilder.is_gutenberg_editor&&!1!==b?(c.undoManager.reset(),c._backendSwitchFrontend(b)):c.Utils.saveBuilder(function(d){!1!==b&&("visual"===c.mode?(c.editing=!0,sessionStorage.setItem("focusBackendEditor",!0),w.location.href=b):(c.undoManager.reset(),c._backendSwitchFrontend(b)))})},libraryItems:{items:[],is_init:null,init(){m(v).one("tb_panel_tab_tb_module_panel_library_wrap",
this.load.bind(this))},load(a,b){const d=this;b=m(b).find(".tb_module_panel_library_wrap");b.addClass("tb_busy");m.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_get_library_items",nonce:themifyBuilder.tb_load_nonce,part:"all",pid:themifyBuilder.post_ID},success(f){d.setData(f);b.removeClass("tb_busy");d.is_init=!0},error(){b.removeClass("tb_busy");t.showLoader("error");d.init();c.toolbar.$el.find(".tb_library_item_list").html("<h3>Failed to load Library Items.</h3>")}})},get(a,b,d){if(void 0!==
this.items[a])d(this.items[a]);else{const f=this;m.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_get_library_item",nonce:themifyBuilder.tb_load_nonce,type:b,id:a},beforeSend(e){t.showLoader("show")},success(e){e.content.gs&&(c.GS.styles=m.extend(!0,{},e.content.gs,c.GS.styles),delete e.content.gs);t.showLoader("hide");"success"===e.status?(f.items[a]=e.content,d(e.content)):t.showLoader("error")},error(){t.showLoader("error")}})}},template(a){let b="";for(let d=0,f=
a.length;d<f;++d){let e="part";-1!==a[d].post_type.indexOf("_rows",5)?e="row":-1!==a[d].post_type.indexOf("_module",5)&&(e="module");b+='<div class="tb_library_item tb_item_'+e+'" draggable="true" data-type="'+e+'" data-id="'+a[d].id+'">';b+='<div class="tb_library_item_inner"><span>'+a[d].post_title+"</span>";b+='<a href="#" class="remove_item_btn tb_disable_sorting tf_close" title="Delete"></a></div></div>'}return b},setData(a){a='<span class="tb_no_content" style="display:none">No library content found.</span>'+
...
d[f].as&&a.setAttribute("as",d[f].as),b.appendChild(a)},7E3);m(v).one("tb_panel_tab_tb_module_panel_rows_wrap",this.load.bind(this))},load(a,b){const d=this;b=m(b).find(".tb_predesigned_rows_list");b.addClass("tb_busy");m.getJSON(themifyBuilder.paths.rows_index).done(function(f){d.setData(f,b)}).fail(function(f,e,h){d.setData({},b);d.is_init=null;t.showLoader("error");c.toolbar.$el.find(".tb_predesigned_rows_container").append("<h3>"+ThemifyConstructor.label.rows_fetch_error+"</h3>");m(v).one("tb_panel_tab_tb_module_panel_rows_wrap",
...
a.target,a=Math.max(a.scrollHeight-(a.scrollTop+a.offsetHeight),0),0<a&&200>=a&&this.addNewItems())}},pageBreakModule:{countModules(){const a="visual"===c.mode,b=a?v.getElementsByClassName("module-page-break"):v.getElementsByClassName("tb-page-break");for(let d=b.length-1;-1<d;--d)!0===a?b[d].getElementsByClassName("page-break-order")[0].textContent=d+1:b[d].getElementsByClassName("page-break-overlay")[0].textContent="PAGE BREAK - "+(d+1)},get(){return[{cols:[{grid_class:"col-full first last",modules:[{mod_name:"page-break"}]}],
column_alignment:"col_align_middle",styling:{custom_css_row:"tb-page-break"}}]}},common:{btn:null,is_init:null,clicked:null,init(){const a=this;let b=v.createElement("div"),d=c.toolbar.$el;b.className="tb_modules_panel_wrap";b.id="tb_module_panel_dropdown";this.btn=m(b);d=d.add(t.Lightbox.$lightbox);"visual"!==c.mode&&null!==v.querySelector(".edit-post-layout__content")?m(".edit-post-layout__content")[0].appendChild(this.btn[0]):z.body[0].appendChild(this.btn[0]);if("visual"===c.mode)c.toolbar.$el.find(".tb_module_types li").on("click",
...
var d=a.data("target");const f=a.closest(".tb_modules_panel_wrap");f.find("."+a.data("hide")).hide();const e=f.find("."+d),h=f.find(".tb_no_content");0<e.length?(h.hide(),e.show()):h.show();a.closest("li").addClass("current").siblings().removeClass("current");f.find(".tb_module_panel_search_text").val("").focus().trigger("keyup");m(v).triggerHandler("tb_panel_tab_"+d,f);d=b.parent().find(".tb_ui_dropdown_label");0<d.length&&d.text(a.text());c.Utils.hideOnClick(b)},show(a,b){a.preventDefault();a.stopPropagation();
...
z.trigger("disableInline")},resize(){null!==this.btn&&c.Utils.addViewPortClass(this.btn[0])},hide(a){function b(){if(!0===a||!d.btn.is(":hover")){let f=z.body;null!==d.btn&&(d.btn.hide().css("width",""),d.clicked&&d.clicked[0].classList.remove("clicked"),d.clicked=null);m(v).off("click",b);m(w.document).off("click",b);"visual"===c.mode&&(f=f.add(m("body",w.document)),"desktop"!==c.activeBreakPoint&&(m("body",w.document).height(v.body.scrollHeight),z.body.css("padding-bottom","")));f.removeClass("tb_panel_dropdown_openend")}}
const d=this;if(!0===a)b();else{if("visual"===c.mode)m(w.document).on("click",b);m(v).on("click",b)}},search(a){var b=m(a.currentTarget);a=b.closest(".tb_modules_panel_wrap");const d=a.find(".tb_module_types .current").first().data("target");b=m.trim(b.val());let f=!1,e=!1,h=!1,g=!1,k=!1;"tb_module_panel_modules_wrap"===d?(f=a.find(".tb_module"),h=!0):"tb_module_panel_rows_wrap"===d&&c.toolbar.preDesignedRows.is_init?(c.toolbar.preDesignedRows.addNewItems(b),e=a.find(".tb_ui_dropdown_label").data("active"),
f=a.find(".predesigned_row"),k=!0):"tb_module_panel_library_wrap"===d&&(f=a.find(".tb_library_item"),e=a.find(".tb_library_types .current").data("target"),g=!0);if(!1!==f){const p=""===b,l=p?!1:new RegExp(b,"i");f.each(function(){if(e&&!this.classList.contains(e))return!0;let q=h?m(this).find(".module_name"):g?m(this).find(".tb_library_item_inner span"):m(this).find(".tb_predesigned_rows_title");p||l.test(q.text())?m(this).show():m(this).hide()});p?a.removeClass("tb_module_panel_searching"):a.addClass("tb_module_panel_searching");
h?a.find(".tb_module_category_content").each(function(){this.parentNode.style.display=!1!==p||m(this).find(".tb_module:visible").length?"block":"none"}):k&&c.toolbar.preDesignedRows.masonry(a[0].getElementsByClassName("tb_predesigned_rows_container")[0])}},clear(a){a.preventDefault();a.stopPropagation();a=m(this).parent().children("input").first();0<a.length&&(a.val(""),a[0].hasAttribute("data-search")?a.trigger("keyup").focus():(a.trigger("change"),z.triggerEvent(a[0],"change")))}},help:{init(){m(".tb_help_btn",
c.toolbar.$el).on("click",this.show.bind(this))},show(a){a.preventDefault();a.stopPropagation();const b=this,d=function(e){w.document.body.insertAdjacentHTML("beforeend",e);e=m("#tb_help_lightbox",w.document.body);m(".tb_help_tab_link",e).on("click",b.mainTabs.bind(b));m(".tb_player_btn",e).on("click",b.play.bind(b));m(".tb_help_menu a",e).on("click",b.tabs.bind(b));m(".tb_close_lightbox",e).on("click",b.close.bind(b));e.slideDown()};let f=!1;t.showLoader("show");w.Themify.LoadCss(themifyBuilder.builder_url+
"/css/editor/help-lightbox.css",null,null,null,function(){f||d(f);f=!0});m.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{tb_load_nonce:themifyBuilder.tb_load_nonce,action:"tb_help"},complete(){t.showLoader("spinhide")},success(e){f?d(e):f=e}})},play(a){a.preventDefault();a.stopPropagation();a=m(a.currentTarget).closest("a");const b=a.prop("href"),d=v.createElement("iframe");d.setAttribute("frameborder","0");d.setAttribute("allow","autoplay; fullscreen");d.setAttribute("src",b+"?rel=0&showinfo=0&autoplay=1&enablejsapi=1&html5=1&version=3");
a.replaceWith(d)},tabs(a){a.preventDefault();a.stopPropagation();a=m(a.currentTarget);const b=m(".tb_help_video_wrapper",w.document),d=b.find(a.attr("href")),f=d.find(".tb_player_btn");b.find(".tb_player_wrapper").removeClass("current").hide();d.addClass("current").show();a.closest("li").addClass("current").siblings().removeClass("current");this.stopPlay();0<f.length?f.trigger("click"):this.startPlay()},execute(a,b){a.contentWindow.postMessage('{"event":"command","func":"'+b+'","args":""}',"*")},
stopPlay(){const a=this;m(".tb_player_wrapper",w.document).each(function(){if(!this.classList.contains("current")){let b=m(this).find("iframe");0<b.length&&a.execute(b[0],"pauseVideo")}})},startPlay(){const a=m(".tb_player_wrapper.current",w.document).find("iframe");0<a.length&&this.execute(a[0],"playVideo")},close(a,b){a.preventDefault();a.stopPropagation();m(a.currentTarget).closest("#tb_help_lightbox").slideUp("normal",function(){m(this).next(".tb_overlay").remove();m(this).remove();b&&b()})},
mainTabs(a){a.preventDefault();a.stopPropagation();a=m(a.currentTarget);const b=m(".tb_help_lightbox_inner_wrapper",w.document);a.hasClass("tb_help_active_tab")||(b.find(".tb_help_active_tab").removeClass("tb_help_active_tab"),a.addClass("tb_help_active_tab"),b.attr("data-active-tab",a.data("type")))}},deviceSwitcher(a){const b=a.target,d=b.parentNode.previousElementSibling;d.classList.contains("tb_breakpoint_switcher")&&(a.tb_device=[b.dataset.height,b.dataset.width],a.target=d,a.currentTarget=d,
this.breakpointSwitcher(a))},breakpointSwitcher(a){a.preventDefault();a.stopPropagation();let b="desktop",d=m("body",w.document);const f=this;var e=a.currentTarget;const h="visual"===c.mode&&c.iframe[0].classList.contains("tb_resizing_start"),g=c.activeBreakPoint,k=function(){f.responsive_grids(b,g);const n=function(){c.Utils.setCompactMode(v.getElementsByClassName("module_column"));d.removeClass("tb_start_animate tb_start_change_mode").toggleClass("tb_responsive_mode","desktop"!==b).removeClass("builder-breakpoint-"+
g).addClass("builder-breakpoint-"+b);z.body.triggerHandler("themify_builder_change_mode",[g,b]);"visual"===c.mode&&(c.iframe[0].style.willChange="",setTimeout(function(){"desktop"!==c.activeBreakPoint?c.Utils.calculateHeight():w.document.body.style.height="";!h&&c.scrollTo&&(m(I).add(w.document).scrollTop(c.scrollTo.offset().top),c.scrollTo=!1);z.trigger("tf_isotop_layout")},150));c.ActionBar.disable=c.clearOnModeChange=null};"visual"===c.mode?c.Utils._onResize(!0,function(){f.iframeScroll("desktop"!==
b);c.ActionBar.hoverCid=null;c.EdgeDrag.clearEdges();setTimeout(n,h?1:100)}):n()};e.classList.contains("breakpoint-tablet")?b="tablet":e.classList.contains("breakpoint-tablet_landscape")?b="tablet_landscape":e.classList.contains("breakpoint-mobile")&&(b="mobile");if(void 0!==a.tb_device||!z.body[0].classList.contains("builder-breakpoint-"+b)){var p;e="desktop"!==b?void 0!==a.tb_device&&a.tb_device[1]?a.tb_device[1]:c.Utils.getBPWidth(b)-1:"";if(c.isPreview){var l={tablet_landscape:768,tablet:1024,
mobile:667};void 0!==l[b]&&(p=void 0!==a.tb_device&&a.tb_device[0]?a.tb_device[0]:l[b])}if(g===b&&void 0!==a.originalEvent&&(e?e+"px":e)===c.iframe[0].style.width&&(p?p+"px":p)===c.iframe[0].style.height)return d.removeClass("tb_start_animate tb_start_change_mode"),!1;c.ActionBar.disable=!0;var q=[];if("visual"===c.mode){null===c.clearOnModeChange&&c.ActionBar.clear();if(!h&&!c.isPreview){a=c.Instances.Builder[0].el.children;const n=I.innerHeight;l=function(r){if(null!==r&&void 0!==r){const u=r.getBoundingClientRect();
if(0>u.bottom&&0>u.top||u.top>n)r.style.display="none",q.push(r)}};for(let r=a.length-1;-1<r;--r)l(a[r]);l(v.getElementById("headerwrap"));l(v.getElementById("footerwrap"))}d=d.add(z.body)}c.activeBreakPoint=b;d.addClass("tb_start_animate tb_start_change_mode");"visual"===c.mode?(c.iframe[0].style.willChange="width",a=w.document.getElementsByClassName("tb_toolbar_zoom_menu")[0],a.classList.remove("tb_toolbar_zoom_active"),a.getElementsByClassName("tb_toolbar_zoom_menu_toggle")[0].dataset.zoom=100,
"tablet_landscape"===b&&t.Lightbox.dockMode.get()&&(a=m(".tb_workspace_container",w.document).width(),a<e&&(e=a)),c.iframe[0].parentNode.classList.remove("tb_zoom_bg"),h?k():(w.document.body.offsetHeight,c.iframe.one("transitionend",function(){for(let n=q.length-1;-1<n;--n)q[n].style.display="";setTimeout(k,10)}),c.iframe[0].style.width=e?e+"px":"",c.iframe[0].style.height=p?p+"px":"")):k()}},iframeScroll(a){const b=m(w.document);b.off("scroll.themifybuilderresponsive");if(a)b.on("scroll.themifybuilderresponsive",
function(){I.scrollTo(0,m(this).scrollTop())})},responsive_grids(a,b){z.LoadCss(tbLocalScript.css_module_url+"responsive-column.css");const d=v.querySelectorAll(".row_inner,.subrow_inner"),f="desktop"===a,e=f||"desktop"===b;for(let k=d.length-1;-1<k;--k){var h=d[k].getAttribute("data-basecol");if(null!==h){let p=d[k].children;var g=d[k].dataset["col_"+a];let l=p[0],q=p[p.length-1];if(!f){if("desktop"!==b){d[k].classList.remove("tb_3col");let n=d[k].getAttribute("data-col_"+b);n&&d[k].classList.remove(m.trim(n.replace("tb_3col",
"").replace("mobile","column").replace("tablet","column")))}if(g&&"-auto"!==g&&g!==a+"-auto"){if(g=d[k].getAttribute("data-col_"+a)){d[k].classList.add("tb_grid_classes","col-count-"+h);g=g.split(" ");for(let n=0,r=g.length;n<r;++n)d[k].classList.add(m.trim(g[n].replace("mobile","column").replace("tablet","column")))}}else d[k].classList.remove("tb_grid_classes","col-count-"+h)}if(e)for(let n=0,r=p.length;n<r;++n)h=p[n].dataset.w,void 0!==h&&(p[n].style.width=f?h+"%":"");"rtl"===d[k].getAttribute("data-"+
a+"_dir")?(l.classList.remove("first"),l.classList.add("last"),q.classList.remove("last"),q.classList.add("first"),d[k].classList.add("direction-rtl")):(l.classList.remove("last"),l.classList.add("first"),q.classList.remove("first"),q.classList.add("last"),d[k].classList.remove("direction-rtl"))}}},Panel:{el:null,init(){this.el=c.toolbar.$el.find(".tb_toolbar_add_modules_wrap");this.el.on("click",".add_module_btn",this.initEvents.bind(this));this.compactToolbar();"visual"===c.mode&&t.Lightbox.dockMode.setDoc()},
initEvents(a){a.preventDefault();a.stopPropagation();const b=a.currentTarget.dataset.type;"module"===b?this.add_module(a):"row"===b?this.click_add_sub_row(a):"page_break"===b?this.click_add_page_break(a):"predesigned"===b&&c.toolbar.preDesignedRows.get(a.currentTarget.closest(".predesigned_row").dataset.slug,function(d){const f=c.Instances.Builder[c.builderIndex].$el.find(".module_row").last();c.Mixins.Builder.rowDrop(d,m("<div>").insertAfter(f),!0)})},setFocus(){c.toolbar.el.getElementsByClassName("tb_module_panel_search_text")[0].focus()},
add_module(a,b){a.preventDefault();a.stopPropagation();b&&0!==b.length||(b=c.Instances.Builder[c.builderIndex].newRowAvailable(1,!0).find(".tb_holder").first());c.Mixins.Builder.moduleDrop(m(a.currentTarget).closest(".tb_module"),b)},click_add_sub_row(a,b){a.preventDefault();a.stopPropagation();const d=!!b;a=m(a.currentTarget).closest(".tb_row_grid").data("slug");let f=!1;b=b||c.Instances.Builder[c.builderIndex].$el.find(".module_row").last();0===b.length&&(b=c.Instances.Builder[c.builderIndex].$el.find("#tb_add_container"),
f=!0);d?b.hasClass("tb_module_front")?c.Mixins.Builder.subRowDrop(a,m("<div>").insertAfter(b)):c.Mixins.Builder.subRowDrop(a,m("<div>").appendTo(b)):c.Mixins.Builder.rowDrop(c.Utils.grid(a),!1===f?m("<div>").insertAfter(b):m("<div>").insertBefore(b),!0,!0)},click_add_page_break(a,b){a.preventDefault();a.stopPropagation();b=b||c.Instances.Builder[c.builderIndex].$el.find(".module_row").last();c.Mixins.Builder.rowDrop(c.toolbar.pageBreakModule.get(),m("<div>").insertAfter(b),!0);c.toolbar.pageBreakModule.countModules()},
compactToolbar(){function a(){c.toolbar.$el.outerWidth()<b?w.document.body.classList.add("tb_compact_toolbar"):w.document.body.classList.remove("tb_compact_toolbar");c.toolbar.common.resize()}const b="visual"===c.mode?850:750;m(w).on("resize.compact",a);if("visual"===c.mode)w.jQuery("body").one("themify_builder_ready",a);else a()}},toggleFavoriteModule(){var a=m(this),b=a.closest(".tb_module"),d=a.parent().data("module-slug");m.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_module_favorite",
module_name:d,module_state:+!b.hasClass("favorited")},beforeSend(f){function e(h,g){function k(){if(h.length){if(g)var p=0<h.closest("#tb_module_panel_dropdown").length?c.toolbar.$el:m("#tb_module_panel_dropdown");h.removeAttr("style");var l=h.data("categories").split(","),q=h.closest(".tb_module_panel_modules_wrap"),n=q.find('.tb_module_category_content[data-category="favorite"]');if(h.hasClass("favorited")){for(var r=l.length-1;-1<r;--r){var u=q.find('.tb_module_category_content[data-category="'+
l[r]+'"]').parent();u.find(".tb_module.tb-module-"+d).css({opacity:0,transform:"scale(0.5)"}).remove();u.find(".tb_module").length||u.css({display:"none"})}n.parent().css({display:"block"});h.clone().css({opacity:0,transform:"scale(0.5)"}).appendTo(n).css({opacity:1,transform:"scale(1)"})}else for(r=l.length-1;-1<r;--r){u=q.find('.tb_module_category_content[data-category="'+l[r]+'"]');let x=h.clone().css({opacity:0,transform:"scale(0.5)"}),y=null,B=parseInt(x[0].dataset.index);for(;0!==--B&&!(y=u.find('[data-index="'+
B+'"]'),0<y.length););y?x.insertAfter(y):u.prepend(x);u.parent().css({display:"block"});x.css({opacity:1,transform:"scale(1)"})}g&&e(p.find(".tb_module.tb-module-"+d),!1);h.remove();n.find(".tb_module").length||n.parent().css({display:"none"})}}if(h.length&&!h.is(":visible"))h.toggleClass("favorited"),k();else h.css({opacity:0,transform:"scale(0.5)"}).one("transitionend",function(){h.toggleClass("favorited").one("transitionend",k)})}e(b,!0)}})},zoom(a){function b(){c.Utils._onResize(!0)}a.preventDefault();
if("desktop"!==c.activeBreakPoint)return!0;var d=m(a.currentTarget);a=d.data("zoom");let f=m(".tb_iframe",w.document),e=d.closest(".tb_toolbar_zoom_menu");d.hasClass("tb_toolbar_zoom_menu_toggle")?(a="100"==a?50:100,d.data("zoom",a),d=d.next("ul").find('[data-zoom="'+a+'"]')):e.find(".tb_toolbar_zoom_menu_toggle").data("zoom",a);f.removeClass("tb_zooming_50 tb_zooming_75");d.parent().addClass("selected-zoom-size").siblings().removeClass("selected-zoom-size");"50"==a||"75"==a?(d="50"==a?2:1.25,f.addClass("tb_zooming_"+
a).one("transitionend",b).parent().addClass("tb_zoom_bg").css("height",Math.max(w.innerHeight*d,600)),e.addClass("tb_toolbar_zoom_active"),c.zoomMeta.isActive=!0,c.zoomMeta.size=a,z.body.addClass("tb_zoom_only")):(f.addClass("tb_zooming_"+a).one("transitionend",b).parent().css("height",""),e.removeClass("tb_toolbar_zoom_active"),c.zoomMeta.isActive=!1,z.body.removeClass("tb_zoom_only"))},previewBuilder(a){a.preventDefault();m(a.currentTarget).toggleClass("tb_toolbar_preview_active");c.isPreview=!c.isPreview;
c.isPreview||(c.iframe[0].style.height="");z.body.toggleClass("tb_preview_only themify_builder_active");m("body",w.document).toggleClass("tb_preview_parent");if(c.isPreview){const d=v.getElementsByClassName("row_inner");for(let f=d.length-1;-1<f;--f)if(d[f].classList.contains("col-count-1")&&0===d[f].getElementsByClassName("active_module").length){var b=d[f].getElementsByClassName("module_column")[0];if((b=c.Models.Registry.lookup(b.getAttribute("data-cid")))&&0===Object.keys(b.get("styling")).length){b=
d[f].closest(".module_row");let e=c.Models.Registry.lookup(b.getAttribute("data-cid"));e&&0===Object.keys(e.get("styling")).length&&b.classList.add("tf_hide")}}}else m(".tf_hide.module_row").removeClass("tf_hide");"visual"===c.mode&&(!w.document.body.classList.contains("tb_panel_minimized")&&t.Lightbox.dockMode.get()&&c.Utils._onResize(!0),c.isPreview||"desktop"===c.activeBreakPoint||(a.tb_device="mobile"===c.activeBreakPoint?[tbLocalScript.breakpoints[c.activeBreakPoint],""]:tbLocalScript.breakpoints[c.activeBreakPoint],
a.currentTarget=a.target=c.toolbar.el.getElementsByClassName("breakpoint-"+c.activeBreakPoint)[0],this.breakpointSwitcher(a)));c.vent.trigger("dom:preview")},toggleAccordion(a){m(a.currentTarget).closest(".tb_module_panel_tab_acc_component").toggleClass("tb_collapsed")},closeFloat(a){a&&(a.preventDefault(),a.stopPropagation(),localStorage.setItem("tb_panel_closed",!0));w.document.body.classList.add("tb_panel_closed")},openFloat(a){a&&(a.preventDefault(),a.stopPropagation(),localStorage.removeItem("tb_panel_closed"));
w.document.body.classList.remove("tb_panel_closed");c.toolbar.common.hide(!0)}});c.Forms={Data:{},Validators:{},parseSettings(a,b){var d=a.classList;b=b?a.getAttribute("data-input-id"):a.getAttribute("id");if(!d.contains("tb_row_js_wrapper")){var f=a.closest(".tb_field");if(null!==f&&!f.classList.contains("_tb_hide_binding")&&("none"!==f.style.display||-1===f.className.indexOf("tb_group_element_"))&&(f=f.parentNode,f.classList.contains("tb_multi_fields")&&f.parentNode.classList.contains("_tb_hide_binding")))return!1}f=
"";if(d.contains("tb_lb_wp_editor"))"undefined"!==typeof tinyMCE?(f=a.id,d=tinyMCE.get(f),f=null!==d?!1===d.hidden?d.getContent():switchEditors.wpautop(tinymce.DOM.get(f).value):a.value):f=a.value;else if(d.contains("themify-checkbox")){f=[];a=a.getElementsByClassName("tb-checkbox");d=d.contains("tb_switcher");for(let k=0,p=a.length;k<p;++k)!0!==d&&!0!==a[k].checked||""===a[k].value||f.push(a[k].value);f=0<f.length?f.join("|"):d?"":!1}else if(d.contains("themify-layout-icon"))f=a.getElementsByClassName("selected")[0],
f=void 0!==f?f.id:"";else if(d.contains("tb_search_input")){if(f=a.getAttribute("data-value"),a=a.closest(".tb_input").getElementsByClassName("query_category_multiple")[0])a=void 0===a?"":a.value.trim(),f=""!==a?a+"|"+(-1!==a.indexOf(",")?"multiple":"single"):f+"|single"}else if(d.contains("tb_radio_input_container")){a=a.getElementsByTagName("input");d=null;for(var e=a.length-1;-1<e;--e)if(!0===a[e].checked){d=a[e];break}null===d||"desktop"!==c.activeBreakPoint&&d.classList.contains("responsive_disable")||
(f=d.value)}else if(d.contains("tb_search_container"))f=a.previousElementSibling.dataset.value;else if(d.contains("tb_row_js_wrapper")){f=[];a=a.getElementsByClassName("tb_repeatable_field_content");for(let k=0,p=a.length;k<p;++k){d=a[k].getElementsByClassName("tb_lb_option_child");f[k]={};for(let l=0,q=d.length;l<q;++l)(e=this.parseSettings(d[l],!0))&&(f[k][e.id]=e.v)}}else if(d.contains("module-widget-form-container"))f=m(a).find(":input").themifySerializeObject();else if(d.contains("tb_widget_select"))f=
a.getElementsByClassName("selected")[0],f=void 0!==f?f.dataset.value:"";else if(d.contains("tb_sort_fields_parent")){a=a.children;f=[];for(let k=0,p=a.length;k<p;++k)if(d=a[k].getAttribute("data-type")){e=a[k].getElementsByClassName("tb_sort_field_dropdown")[0];d={type:d,id:a[k].getAttribute("data-id")};if(void 0!==e){d.val={};e=e.getElementsByClassName("tb_lb_sort_child");for(var h=e.length-1;-1<h;--h){var g=this.parseSettings(e[h],!0);g&&(d.val[g.id]=g.v)}}else e=a[k].getElementsByTagName("input")[0].value,
""!==e&&(d.val=JSON.parse(e));f.push(d)}0===f.length&&(f="")}else if(d.contains("tb_accordion_fields")){a=a.children;f={};for(let k=0,p=a.length;k<p;++k)if(d=a[k].getAttribute("data-id"))h=a[k].getElementsByTagName("input")[0],g=a[k].getElementsByClassName("tb_accordion_fields_options")[0],e={},void 0!==g?e.val=this.serialize(g,null,!0):(h=h.value,""!==h&&(e.val=JSON.parse(h))),f[d]=e}else if(d.contains("tb_toggleable_fields")){a=a.children;f={};for(let k=0,p=a.length;k<p;++k)if(d=a[k].getAttribute("data-id"))h=
a[k].getElementsByTagName("input")[0],g=a[k].getElementsByClassName("tb_toggleable_fields_options")[0],e={on:a[k].getElementsByClassName("tb_switcher")[0].getElementsByClassName("toggle_switch")[0].value},void 0!==g?e.val=this.serialize(g,null,!0):(h=h.value,""!==h&&(e.val=JSON.parse(h))),f[d]=e}else if(f=a.value,void 0!==I.tbpDynamic&&b===tbpDynamic.field_name){if(""===f)return!1;"string"===typeof f&&(f=JSON.parse(f))}else{if(b===c.GS.key&&"desktop"!==c.activeBreakPoint)return!1;""!==f&&("builder_content"===
b?"string"===typeof f&&(f=JSON.parse(f)):(a=a.getAttribute("data-opacity"),null!==a&&""!==a&&1!=a&&"0.99"!=a&&(f+="_"+a)))}if(void 0===f||null===f)f="";return{id:b,v:f}},serialize(a,b,d){const f={};a="object"===typeof a?a:w.document.getElementById(a);d=d||!1;if(null!==a){a=a.getElementsByClassName(d?"tb_lb_option_child":"tb_lb_option");for(let e=a.length-1;-1<e;--e){let h=this.parseSettings(a[e],d);!1===h||!0!==b&&""===h.v||(f[h.id]=h.v)}}return f},LayoutPart:{cache:[],undo:null,old_id:null,isReload:null,
id:null,init:!1,html:null,el:null,options:null,isSaved:null,scrollTo(a,b){c.scrollTo=c.Forms.LayoutPart.el},edit(a){function b(g){c.ActionBar.clear();v.getElementById("themify_builder_content-"+themifyBuilder.post_ID).insertAdjacentHTML("afterbegin",'<div class="tb_overlay"></div>');f.addClass("tb_active_layout_part").closest(".row_inner").find(".active_module").each(function(){this.classList.contains("tb_active_layout_part")||this.insertAdjacentHTML("afterbegin",'<div class="tb_overlay"></div>')});
const k="themify_builder_content-"+d.id,p=[];d.html=f[0].innerHTML;themifyBuilder.post_ID=ThemifyStyles.builder_id=d.id;f[0].insertAdjacentHTML("afterbegin",h.replace("#postID#",d.id));m("."+k).each(function(){m(this).closest(".active_module").find(".themify-builder-generated-css").first().prop("disabled",!0)});c.Instances.Builder[0].el.classList.remove("tb_active_builder");f.removeClass("active_module module").closest(".tb_holder").removeClass("tb_holder").addClass("tb_layout_part_parent").closest(".module_row").addClass("tb_active_layout_part_row");
...
column_alignment:ba?"col_align_middle":"col_align_top"};e={desktop_dir:"ltr",tablet_dir:"ltr",tablet_landscape_dir:"ltr",mobile_dir:"ltr",col_tablet_landscape:"-auto",col_tablet:"-auto",col_mobile:"-auto"};for(let g in d)""!==d[g]&&null!==d[g]&&d[g]!==b[g]||delete d[g];b=f.get("styling");for(let g in e)f=a.getAttribute("data-"+g),null===f||""===f||f===e[g]||"-auto"===e[g]&&-1!==f.indexOf("-auto")||(d[g]=f.trim());b&&0<Object.keys(b).length&&(delete b.cid,d.styling=b)}return d},selectedGridMenu(a,
b){var d=ThemifyConstructor.breakpointsReverse;const f=c.Models.Registry.lookup(a.getAttribute("data-cid")),e=a.getElementsByClassName(b+"_inner")[0];var h=f.get("gutter");const g=f.get("column_alignment")||"col_align_top",k=f.get("column_h"),p=f.get("desktop_dir"),l="row"===b?f.get("styling"):null;b=[];const q={},n=e.children,r=n.length;for(let u=r-1;-1<u;--u)n[u].className=n[u].className.replace(/first|last/ig,""),1!==r&&(0===u?n[u].className+="rtl"===p?" last":" first":u===r-1&&(n[u].className+=
"rtl"===p?" first":" last"));b.push("col-count-"+r);q["data-basecol"]=r;null!==l&&void 0!==l.row_anchor&&""!==l.row_anchor&&(a.getElementsByClassName("tb_row_anchor")[0].textContent=l.row_anchor);"gutter-default"!==h&&b.push(h);k&&b.push("col_auto_height");b.push(g);"ltr"!==p&&b.push("direction-rtl");for(a=d.length-1;-1<a;--a)h=f.get(d[a]+"_dir"),"ltr"!==h&&""!==h&&(q["data-"+d[a]+"_dir"]=h),"desktop"!==d[a]&&(h=f.get("col_"+d[a]),"-auto"!==h&&""!==h&&void 0!==h&&(q["data-col_"+d[a]]=h));for(d=b.length-
1;-1<d;--d)b[d]&&e.classList.add(b[d]);for(let u in q)e.setAttribute(u,q[u])},clear(a,b){void 0===b&&(b=Array.isArray(a));const d=!0===b?[]:{},f=void 0!==I.tbpDynamic?tbpDynamic.field_name:!1;for(let g in a)if(a.hasOwnProperty(g)&&"null"!==g)if(Array.isArray(a[g])){var e=this.clear(a[g],!0);0<e.length&&(!0===b?d.push(e):d[g]=e)}else if(g===f)if("{}"===a[g]||""===a[g])delete a[g],delete d[g];else{e=a[g];"string"===typeof e&&(e=JSON.parse(e));for(let k in e)"undefined"===typeof e[k].repeatable&&(void 0===
e[k].item?delete e[k]:void 0!==a[k]&&(delete a[k],delete d[k]));a[g]=d[g]=e}else if("object"===typeof a[g]){if("breakpoint_mobile"===g||"breakpoint_tablet"===g||"breakpoint_tablet_landscape"===g){e=a[g];for(let k in e)if(void 0===e[k]||null===e[k]||""===e[k])delete e[k];else if("px"===e[k]&&-1!==k.indexOf("_unit",2)){var h=k.replace("_unit","");if(void 0===e[h]||""===e[h])delete e[k],""===e[h]&&delete e[h]}}else e=this.clear(a[g],!1);e&&0<Object.keys(e).length&&(d[g]=e)}else if(null!==a[g]&&void 0!==
...
2)||"background_zoom"===g&&""===a[g]||"none"===a[g]&&-1!==g.indexOf("frame_layout")||"solid"===a[g]||!1===a[g]&&(-1!==g.indexOf("_user_role",3)||-1!==g.indexOf("_appearance",3))||!(a[g]&&"false"!==a[g]||"margin-top_opp_top"!==g&&"m_t_h_opp_top"!==g&&0!==g.indexOf("padding_opp_")&&0!==g.indexOf("margin_opp_")))&&e.push(g);if(0<e.length){for(h=e.length-1;-1<h;--h)delete d[e[h]],delete a[e[h]];e.length=0;continue}}!0===b?d.push(a[g]):d[g]=a[g]}else delete d.custom_parallax_scroll_reverse,delete d.custom_parallax_scroll_fade,
delete d[g],delete a.custom_parallax_scroll_reverse,delete a.custom_parallax_scroll_fade,delete a[g];return d},clearElementId(a,b){for(let f in a){!0===b?a[f].element_id=c.Utils.generateUniqueID():delete a[f].element_id;let e=void 0!==a[f].styling?a[f].styling:a[f].mod_settings;if(void 0!==e){if(void 0!==e.custom_css_id&&""!==e.custom_css_id)for(var d=2;;){let h=e.custom_css_id+"-"+d.toString(),g=v.getElementById(h);if(null===g||null===g.closest(".module_row")){e.custom_css_id=h;break}++d}void 0!==
e.builder_content&&(d="string"===typeof e.builder_content?JSON.parse(e.builder_content):e.builder_content,this.clearElementId(d,!0),e.builder_content=d)}void 0!==a[f].cols?this.clearElementId(a[f].cols,b):void 0!==a[f].modules&&this.clearElementId(a[f].modules,b)}},clearLastEmptyRow(a){for(let d=a.length-1;-1<d;--d){var b=void 0!==a[d].attributes?a[d].attributes:a[d];if(void 0===b.styling||null===b.styling||0===Object.keys(b.styling).length){b=b.cols;let f=!0;for(let e in b)if(void 0!==b[e].modules&&
(0<b[e].modules.length||0<Object.keys(b[e].modules).length)||void 0!==b[e].styling&&null!==b[e].styling&&0<Object.keys(b[e].styling).length){f=!1;break}if(!0===f)void 0!==a[d].cid&&(c.Models.Registry.remove(a[d].cid),a[d].destroy()),a.splice(d,1);else break}else break}},builderPlupload(a,b){const d=!!b;b=d?[b]:t.Lightbox.$lightbox[0].getElementsByClassName("tb_plupload_upload_uic");var f=b.length;if(0<f)for(a=d?!1:"new_elemn"===a?".plupload-clone":!1,void 0===this.pconfig&&(this.pconfig=JSON.parse(JSON.stringify(themify_builder_plupload_init)),
this.pconfig.multipart_params._ajax_nonce=themifyBuilder.tb_load_nonce,this.pconfig.multipart_params.topost=themifyBuilder.post_ID),--f;-1<f;--f)if(!b[f].classList.contains("tb_plupload_init")&&(!1===a||b[f].classList.contains(a))){let h=b[f];var e=h.getAttribute("id").replace("tb_plupload_upload_ui","");let g=m.extend(!0,{},this.pconfig),k=h.getAttribute("data-extensions"),p=["browse_button","container","drop_element","file_data_name"];g.multipart_params.imgid=e;for(let l=p.length-1;-1<l;--l)g[p[l]]=
e+this.pconfig[p[l]];g.filters[0].extensions=null!==k?k:null!==c.activeModel?g.filters[0].extensions.replace(/,zip|,txt/,""):"zip,txt";e=new w.plupload.Uploader(g);h.classList.add("tb_plupload_init");d&&e.bind("init",function(l){m(l.settings.browse_button).click()});e.bind("FilesAdded",function(l,q){l.refresh();l.start();t.showLoader("show")});e.bind("Error",function(l,q){l=m(".prompt-box .show-error");m(".prompt-box .show-login").hide();l.show();0<l.length&&l.html('<p class="prompt-error">'+q.message+
"</p>");m(".overlay, .prompt-box").fadeIn(500)});e.bind("FileUploaded",function(l,q,n){const r=JSON.parse(n.response);l=m("#tb_alert",w.document);n=200!==n.status||r.error?"error":"done";if(r.error)t.showLoader(n),alert(r.error);else if(d){const u=m("#tb_row_wrapper").children().clone(!0);l.promise().done(function(){r.custom_css&&(S=r.custom_css);c.Forms.reLoad(r,themifyBuilder.post_ID);const x=m("#tb_row_wrapper").children().clone(!0);t.Lightbox.close();c.undoManager.push("","","","import",{before:u,
after:x,bid:themifyBuilder.post_ID})})}else t.showLoader(n),l=this.getOption().container.closest(".tb_input"),n=l.getElementsByClassName("tb_uploader_input")[0],l=l.getElementsByClassName("thumb_preview")[0],n.value=r.large_url?r.large_url:r.url,void 0!==l&&ThemifyConstructor.file.setImage(l,r.thumb),z.triggerEvent(n,"change")});e.init();h.classList.remove("plupload-clone")}},grid(a){const b=[];a=parseInt(a);if(1===a)b.push({grid_class:"col-full"});else for(let d=0;d<a;++d)b.push({grid_class:"col"+
a+"-1"});return[{cols:b}]},setCompactMode(a){a instanceof jQuery&&(a=a.get());for(let b=a.length-1;-1<b;--b)185>a[b].clientWidth?a[b].classList.add("compact-mode"):a[b].classList.remove("compact-mode")},initNewEditor(a){if(3<parseInt(tinyMCE.majorVersion)){const b=tinyMCEPreInit.mceInit.tb_lb_hidden_editor;b.elements=a;b.selector="#"+a;a=new tinyMCE.Editor(a,b,tinyMCE.EditorManager);a.render();return a}},initQuickTags(a){"function"===typeof w.QTags&&(w.quicktags({id:a}),w.QTags._buttonsInit())},_getColClass(a){for(let b=
0,d=a.length;b<d;++b)if(-1!==this.gridClass.indexOf(a[b]))return a[b].replace("col","")},getMouseEvents(){const a={mousedown:"mousedown",mousemove:"mousemove",mouseup:"mouseup"};z.isTouch&&(a.mousedown="touchstart",a.mousemove="touchmove",a.mouseup="touchend");return a},saveBuilder(a,b){if(null!==c.activeModel||0===c.builderIndex&&0<t.Lightbox.$lightbox.length&&t.Lightbox.$lightbox[0].classList.contains("tb_custom_css_lightbox")){var d=t.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0];
d&&d.click()}d=c.Instances.Builder[c.builderIndex];const f=this,e=d.$el.data("postid"),h=c.Mixins.Builder.toJSON(d.el);if(!0===b)return{id:e,data:h};c.GS.setImport(c.GS.styles,null,null,!0);null===S&&(S=themifyBuilder.custom_css,delete themifyBuilder.custom_css);t.showLoader("show");f.saveCss(h,S,e).done(function(){m.ajax({type:"POST",url:themifyBuilder.ajaxurl,cache:!1,data:{action:"tb_save_data",tb_load_nonce:themifyBuilder.tb_load_nonce,id:e,custom_css:S,data:JSON.stringify(c.Utils.clear(h)),sourceEditor:"visual"===
c.mode?"frontend":"backend"},complete:function(g,k){"success"!==k?(t.showLoader("error"),alert(themifyBuilder.i18n.errorSaveBuilder)):(g=g.responseJSON,m.isFunction(a)&&a.call(f,g),t.showLoader("hide"),c.editing=!0,z.body.triggerHandler("themify_builder_save_data",[g]))}})}).fail(function(){t.showLoader("error")})},saveCss(a,b,d){return m.ajax({type:"POST",url:themifyBuilder.ajaxurl,cache:!1,data:{css:JSON.stringify(c.GS.createCss(a,a[0]&&a[0].mod_name||null,!0)),action:"tb_save_css",custom_css:b,
tb_load_nonce:themifyBuilder.tb_load_nonce,id:d}})},runJs(a,b,d){if(!b)if(null!==c.activeModel)b=c.activeModel.get("elType");else if(a){var f=c.Models.Registry.lookup(a.data("cid"));f&&(b=f.get("elType"))}f=[];if("visual"===c.mode&&("module"===b&&z.fontAwesome(a),!0!==d)){d=(a?a[0]:v).querySelectorAll("img[data-w]");for(let e=d.length-1;-1<e;--e){let h=d[e].getAttribute("width"),g=d[e].getAttribute("height");(h||g)&&f.push(c.Utils.resizeImage(d[e],h,g))}}Promise.allSettled(f).finally(e=>{z.reRun(a,
...
themifyBuilder.fontello_prefix+"$":"^"+themifyBuilder.fontello_prefix)).test(a))return b=v.createElement("i"),b.setAttribute("class",a),b;a="tf-"+a.trim().replace(" ","-");const d=v.createElementNS("http://www.w3.org/2000/svg","use"),f=v.createElementNS("http://www.w3.org/2000/svg","svg");let e="tf_fa "+a;b&&(e+=" "+b);f.setAttribute("class",e);d.setAttributeNS(null,"href","#"+a);f.appendChild(d);return f},getBPWidth(a){a=Array.isArray(themifyBuilder.breakpoints[a])?themifyBuilder.breakpoints[a]:
themifyBuilder.breakpoints[a].toString().split("-");return a[a.length-1]},generateUniqueID(){return(Math.random().toString(36).substr(2,4)+(new Date).getUTCMilliseconds().toString()).substr(0,7)},scrollTo(a){("desktop"===c.activeBreakPoint?m("html,body"):m("body",w.document)).scrollTop(a)},scrollToDropped(a,b){a||(a=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_cid_"+b)[0]);if(a)if("visual"===c.mode)this.scrollTo(m(a).offset().top-120);else if(b=v.getElementsByClassName("edit-post-layout__content")[0],
...
b[d])},isInViewport(a){a=a.getBoundingClientRect();let b="";0>a.left?b="tb_touch_left":a.right-1>=v.documentElement.clientWidth&&(b="tb_touch_right");if(0>a.top)b+=" tb_touch_top";else if(a.bottom+1>=v.documentElement.clientHeight||I.innerHeight+I.scrollY>=v.body.offsetHeight&&a.bottom+20>=v.documentElement.clientHeight)b+=" tb_touch_bottom";return""===b?!1:b},canvas:null,ctx:null,cache_images:{},resizeImage(a,b,d,f){"0"===b&&(b="");if(!b&&!d)return new Promise((h,g)=>{"string"!==typeof a&&(a.style.visibility=
a.style.display="");h([a,b,d,b,d])});null===this.canvas&&(this.canvas=v.createElement("canvas"),this.ctx=this.canvas.getContext("2d"),this.ctx.imageSmoothingQuality="high",this.ctx.imageSmoothingEnabled=!0);const e=this;return new Promise((h,g)=>{let k=v.createElement("span");const p=function(q){let n=q.getAttribute("data-orig");const r=function(){b?(q.setAttribute("width",b),q.style.width&&(q.style.width=b+"px")):q.removeAttribute("width");d?(q.setAttribute("height",d),q.style.height&&(q.style.height=
d+"px")):q.removeAttribute("height")},u=function(){b&&(b=parseInt(b));d&&(d=parseInt(d));var y=f.naturalWidth,B=f.naturalHeight,A=y/B,E=b,C=d;E||(E=b=parseInt(C*A));C||(C=d=parseInt(E/A));var G=E/y,K=C/B;A=q.currentSrc;G=G>K?G:K;E=E/G+.5>>0;C=C/G+.5>>0;y=(y-E)/2>>0;B=(B-C)/2>>0;G=q.getAttribute("srcset");K=q.getAttribute("data-ext");K||q.hasAttribute("data-ext")||(K=A.slice((A.lastIndexOf(".")-1>>>0)+2),"jpg"===K&&(K="jpeg"),K="image/"+K,q.setAttribute("data-ext",K));e.canvas.width=E;e.canvas.height=
C;e.ctx.drawImage(f,y,B,E,C,0,0,E,C);G&&-1!==G.indexOf(A)?q.setAttribute("srcset",G.replaceAll(A,e.canvas.toDataURL(K,1))):q.setAttribute("src",e.canvas.toDataURL(K,1));r();k&&k.remove();q.style.visibility=q.style.display="";k=n=null;h([q,b,d,E,C])};if(!n){n=q.getAttribute("src").trim();if(0!==n.indexOf(themifyBuilder.upload_url)||q.closest("[data-hasEditor]")){k&&k.remove();q.style.visibility=q.style.display="";r();k=n=null;h([q,b,d,b,d]);return}var x=q.getAttribute("width");const y=q.getAttribute("height");
x&&y&&(x="-"+x+"x"+y,-1!==n.indexOf(x)&&(n=n.replace(x,"")));q.dataset.orig=n}if(f)u();else{const y=z.hash(n+b+d);void 0!==e.cache_images[y]?(f=e.cache_images[y],u(),f=null):(f=new Image,f.src=n,f.crossOrigin="anonymous",f.decode().then(function(){u();e.cache_images[y]=f}).catch(B=>{k&&k.remove();q.style.visibility=q.style.display="";console.log(B);g()}))}};if("string"===typeof a){let q=0;const n=setInterval(function(){++q;8<q&&clearInterval(n);const r=c.Instances.Builder[c.builderIndex].el.querySelector(a);
if(null!==r){clearInterval(n);k.className="tf_loader tf_loader_center";var u=r.closest(".active_module");if(u){const x=u.getElementsByClassName("tf_loader_center")[0];void 0!==x&&x.parentNode===u||u.prepend(k)}else u=r.nextElementSibling,null!==u&&u.classList.contains("tf_loader_center")||r.after(k);p(r)}},8)}else{if(!f){k.className="tf_loader tf_loader_center";var l=a.closest(".active_module");if(l){const q=l.getElementsByClassName("tf_loader_center")[0];void 0!==q&&q.parentNode===l||l.prepend(k)}else l=
image.nextElementSibling,null!==l&&l.classList.contains("tf_loader_center")||a.after(k)}p(a)}})},hideOnClick(a){void 0!==a[0]&&(a=a[0]);if(a.classList.contains("tb_ui_dropdown_items")||a.classList.contains("tb_down"))a.classList.add("tb_hide_option"),a.previousElementSibling.blur(),setTimeout(function(){a.classList.remove("tb_hide_option");a=null},500)},calculateHeight(){"visual"===c.mode&&"desktop"!==c.activeBreakPoint&&(w.document.body.style.height=v.body.scrollHeight+"px")},changeOptions(a,b){const d=
"INPUT"===a.tagName&&"hide_anchor"!==b?"keyup":"change",f=this;"keyup"===d&&a.setAttribute("data-prev",a.value);f.custom_css_id=function(e,h,g,k){e=v.getElementById(k);return null===e||g[0].getAttribute("id")===k||null===e.closest(".module_row")?(g[0].setAttribute("id",k),!0):!1};f.row_anchor=function(e,h,g,k){"visual"===c.mode&&(g.removeClass(c.liveStylingInstance.getRowAnchorClass(e.getAttribute("data-prev"))),""!==k&&g.addClass(c.liveStylingInstance.getRowAnchorClass(k)),g.data("anchor",k).attr("data-anchor",
k));c.hasChanged=!0;g.find(".tb_row_anchor").first().text(k.replace("#",""));return!0};f.custom_css=function(e,h,g,k){"visual"===c.mode&&g.removeClass(e.getAttribute("data-prev")).addClass(k);return!0};f.layout=function(e,h,g,k){"visual"===c.mode&&c.liveStylingInstance.bindRowWidthHeight(h,k,g);return!0};f.hide_anchor=function(e,h,g,k){"visual"===c.mode&&"1"===k&&g.data("hideAnchor",k).attr("data-hide-anchor",k);return c.hasChanged=!0};a.addEventListener(d,function(e){let h;var g=null!==c.activeModel&&
c.ActionBar.cid===c.activeModel.cid;let k=!t.Lightbox.$lightbox[0].contains(this),p="hide_anchor"!==b?this.id:"hide_anchor",l="custom_css_id"===p,q=!0!==l||!1!==k&&!0!==g?void 0:t.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0],n;n=!0===k&&!1===g?m(".tb_element_cid_"+c.ActionBar.cid):"visual"===c.mode?c.liveStylingInstance.$liveStyledElmt:m(".tb_element_cid_"+c.activeModel.cid);const r=!1===g&&!0===k?t.clone(n[0]):null;h=this.value;"keyup"===d&&"custom_css"!==b?((h=h.trim())&&
(h=h.replace(/[^a-zA-Z0-9\-_]+/gi,"")),this.value=h):"layout"===b?h=e.detail.val:"hide_anchor"===b&&(h=this.checked?"1":"0");if(f[b].call(f,this,p,n,h)){l&&(m(this).next(".tb_field_error_msg").remove(),void 0!==q&&q.classList.remove("tb_disable_save"));if(!0===k){const u=function(){let x=h;"keyup"===d&&(this.removeEventListener("change",u,{passive:!0,once:!0}),this.removeAttribute("data-isInit"),x=this.value.trim());let y=n.data("cid"),B=c.Models.Registry.lookup(y),A=m.extend(!0,{},B.get("styling"));
A||(A={});const E=m.extend(!0,{},A);A[p]=x;B.set({styling:A},{silent:!0});null!==r&&c.undoManager.push(y,r,n,"save",{bsettings:E,asettings:m.extend(!0,{},A)})};"keyup"===d?this.getAttribute("data-isInit")||(this.setAttribute("data-isInit",1),this.addEventListener("change",u,{passive:!0,once:!0})):u()}c.hasChanged=!0}else l&&(e=v.createElement("span"),e.className="tb_field_error_msg",e.textContent=ThemifyConstructor.label.errorId,this.parentNode.insertBefore(e,this.nextSibling),void 0!==q&&q.classList.add("tb_disable_save"));
!0===g&&(g=k?t.Lightbox.$lightbox.find("#"+p):m("#"+c.ActionBar.el.id).find("#"+p),"keyup"===d?g.val(h).attr("data-prev",h):"layout"===b?(g.find(".selected").removeClass("selected"),""!==h?g.find("#"+h).addClass("selected"):g.children().first().addClass("selected")):"hide_anchor"===b&&(g.find("INPUT")[0].checked=this.checked));"keyup"===d&&this.setAttribute("data-prev",h)},{passive:!0})},visibilityLabel(a,b){var d=b.cid;d=null!==c.activeModel&&d===c.activeModel.cid&&"visibility"===ThemifyConstructor.clicked?
c.Forms.serialize("tb_options_visibility"):void 0;void 0===d&&(d="module"!==b.get("elType")?b.get("styling"):b.get("mod_settings"));if(d){b="";a=a.classList.contains("tb_visibility_hint")?a:a.getElementsByClassName("tb_visibility_hint")[0];const e={visibility_desktop:themifyBuilder.i18n.de,visibility_mobile:themifyBuilder.i18n.mo,visibility_tablet:themifyBuilder.i18n.ta,visibility_tablet_landscape:themifyBuilder.i18n.ta_l,sticky_visibility:themifyBuilder.i18n.s_v};if(void 0!==a){if("hide_all"===d.visibility_all)b=
themifyBuilder.i18n.h_a;else{let h;for(var f in e)h=""===b?"":", ",b+="hide"===d[f]?h+e[f]:""}""!==b?(f=a.getElementsByTagName("span")[0],void 0===f&&(f=v.createElement("span"),a.appendChild(f)),f.textContent=b,a.classList.add("tb_has_visiblity")):a.classList.remove("tb_has_visiblity")}}}};c.ActionBar={cid:null,topH:null,type:null,disable:null,prevExpand:null,needClear:!0,el:null,breadCrumbs:null,breadCrumbsPath:{lightbox:null,rightClick:null},disablePosition:null,isInit:null,isHoverMode:!0,darkMode:null,
inlineEditor:!0,hoverCid:null,contextMenu:null,contextMenuAnimate:null,init(){if(null===this.isInit&&!0!==c.GS.isGSPage){this.isInit=!0;this.el=v.createElement("div");this.breadCrumbs=v.createElement("ul");this.el.id="tb_component_bar";this.breadCrumbs.className="tb_action_breadcrumb";this.el.addEventListener("mousedown",this.mouseDown.bind(this));this.topH=c.toolbar.$el.height();"visual"===c.mode?v.body.appendChild(this.el):c.Instances.Builder[c.builderIndex].el.parentNode.appendChild(this.el);v.addEventListener("click",
this.click.bind(this));v.addEventListener("dblclick",this.click.bind(this));c.Instances.Builder[0].el.addEventListener("mouseover",this.enter);"visual"===c.mode&&w.document.addEventListener("click",this.click.bind(this));var a="visual"===c.mode?null:v.getElementById("tb_canvas_block");null===a?(v.addEventListener("keydown",this.actions.bind(this),{passive:!0}),w.document.addEventListener("keydown",this.actions.bind(this),{passive:!0})):a.addEventListener("keydown",this.actions.bind(this),{passive:!0});
this.changeMode();this.initRightClick(!0)}},changeMode(){this.hoverCid=null;const a=v.body.classList;!0===this.isHoverMode?(a.remove("tb_click_mode"),a.add("tb_hover_mode"),this.el.removeEventListener("click",this.actions)):(a.remove("tb_hover_mode"),a.add("tb_click_mode"),this.el.addEventListener("click",this.actions))},changeDarkMode(){var a=v.getElementById("darkmode-ui"),b="visual"===c.mode?w.document.getElementById("darkmode-ui"):null;!0===this.darkMode?a?(a.disabled=!1,b&&(b.disabled=!1)):(a=
w.document.createElement("link"),b=v.getElementById("visual"!==c.mode?"themify-builder-admin-ui-css":"themify-builder-inline-editor-css"),a.rel="stylesheet",a.href=themifyBuilder.builder_url+"/css/editor/darkmode-ui.css",a.id="darkmode-ui",b.parentNode.insertBefore(a,b.nextSibling),"visual"===c.mode&&w.document.head.appendChild(a.cloneNode())):(a.disabled=!0,b&&(b.disabled=!0))},initRightClick(a){localStorage.getItem("tb_right_click")?!0===a?c.toolbar.el.getElementsByClassName("tb_right_click_mode")[0].checked=
!1:(c.Instances.Builder[0].el.removeEventListener("contextmenu",this.rightClick),this.contextMenu=this.contextMenuAnimate=null):(c.Instances.Builder[0].el.addEventListener("contextmenu",this.rightClick),c.ActionBar.el.removeEventListener("contextmenu",this.rightClick),!0!==this.isHoverMode&&c.ActionBar.el.addEventListener("contextmenu",this.rightClick))},enter(a){const b=c.ActionBar;if(null===b.disable&&(c.Mixins.Builder.columnHover(a.target),!0===b.isHoverMode&&null===b.disablePosition)){"click"===
a.type&&a.preventDefault();a.stopPropagation();var d=a.target;let g=null;var f=d.classList;if(null!==b.prevExpand&&void 0!==b.prevExpand)if(b.prevExpand.contains(d)){if(f.contains("tb_inner_action_more")||f.contains("tb_action_more")){var e=d.getElementsByTagName("ul")[0];void 0!==e&&c.Utils.addViewPortClass(e)}e=b.prevExpand.getElementsByClassName("tb_row_settings")[0];if(void 0!==e){var h=v.getElementById(e.getAttribute("data-href"));if(h.contains(d))return;h.classList.remove("selected");e.classList.remove("selected")}if("module"===
b.type||"column"===b.type){"column"===b.type&&(b.hoverCid=d.parentNode.getAttribute("data-cid"));return}}else{e="module"!==b.type;if(!1===e)"visual"!==c.mode?(e=d.closest(".active_module"),e=null!==e?e.getAttribute("data-cid")!==b.hoverCid:!0):(h=d.closest(".tb_dragger_top"),null!==h&&h.classList.contains("tb_dragger_padding")&&c.EdgeDrag.setModulePosition(h));else if(f.contains("tb_clicked"))return;!0===e&&b.clear()}if(null===d.closest(".tb_dragger_lightbox")){if(f.contains("tb_action_wrap"))g=!f.contains("tb_clicked");
else{if("LI"===d.nodeName&&f.contains("tb_row_settings")&&!f.contains("selected")){b.actions(a);return}if(!f.contains("tb_grid_drag")){d=d.closest("[data-cid]");if(!d)return;f=d.getAttribute("data-cid");if(b.hoverCid===f)return;b.hoverCid=f;e=c.Models.Registry.lookup(f);f=e.get("elType");if("module"===f)g=!0;else if("visual"===c.mode){b.clear();c.EdgeDrag.addEdges(f,e,d);return}}}!0===g&&b.click(a)}}},rightClickGS(a,b,d){this.disable=!0;null!==c.activeModel&&m(".builder_save_button",ThemifyBuilderCommon.Lightbox.$lightbox).click();
const f=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_clicked"),e=c.GS.key;b=b.split(" ");for(let g=f.length-1,k=b.length;-1<g;--g){let p=c.Models.Registry.lookup(f[g].getAttribute("data-cid")),l=t.clone(f[g]),q="module"===p.get("elType")?"mod_settings":"styling",n=m.extend(!0,{},p.get(q)),r=m.extend(!0,{},n);c.activeModel=p;if(n[e])if(!0===d)a&&-1!==n[e].indexOf(a)&&(n[e]=n[e].split(" "),n[e].splice(n[e].indexOf(a),1),n[e]=n[e].join(" "));else for(var h=0;h<k;++h)-1===
n[e].indexOf(b[h])&&(n[e]+=" "+b[h]);else{if(0===k)continue;n[e]=b.join(" ")}h={};h[q]=n;p.set(h,{silent:!0});c.GS.generateValues(a,n[e].split(" "),d);c.undoManager.push(p.cid,l,m(f[g]),"save",{bsettings:r,asettings:n})}this.disable=null;c.activeModel=null},rightClick(a,b){a.stopImmediatePropagation();const d=c.ActionBar;if(!(null!==d.contextMenuAnimate||"visual"===c.mode&&v.activeElement.contentEditable&&c.liveStylingInstance.$liveStyledElmt&&c.liveStylingInstance.$liveStyledElmt[0].contains(v.activeElement))){d.contextMenuAnimate=
!0;if(null===d.contextMenu){const l=function(n){n.stopPropagation();"click"===n.type&&null===n.target.closest(".tb_visibility_wrap")&&n.preventDefault();if("LI"===n.target.nodeName||n.target.classList.contains("toggle_switch")){var r="LI"===n.target.nodeName?n.target.getAttribute("data-action"):"visibility";if(r){d.disable=!0;d.hoverCid=null;if("undo"===r||"redo"===r)if(n="undo"===r?c.undoManager.btnUndo:c.undoManager.btnRedo,"undo"===r&&c.undoManager.hasUndo()||"redo"===r&&c.undoManager.hasRedo())m(n).triggerHandler("click"),
d.disable=null;else{d.disable=null;return}else{var u=this.classList.contains("tb_multiply_selected");let E,C,G,K,O,J,L,N=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_clicked"),R=void 0;"gs_in"!==r&&"move"!==r&&(!0!==u||"delete"!==r&&"paste"!==r||(R=!0),m(".builder_save_button",ThemifyBuilderCommon.Lightbox.$lightbox).click());if("reset"===r)E=c.activeModel,C=m.extend(!0,{},ThemifyConstructor.values),G=ThemifyConstructor.component,K=ThemifyConstructor.beforeData,O=!0===
c.hasChanged,J="visual"===c.mode?c.liveStylingInstance.prefix:null,L="visual"===c.mode?c.liveStylingInstance.$liveStyledElmt:null;else{if("move"===r){d.disable=null;return}if("gs_in"===r){if(!1===u){r=c.Models.Registry.lookup(N[0].dataset.cid);var x=m.extend(!0,{},ThemifyConstructor.values);ThemifyConstructor.values="module"===r.get("elType")?r.get("mod_settings"):r.get("styling")}if(r=c.GS.globalStylesHTML())n=d.contextMenu.querySelector("#tb_inline_gs"),n.innerHTML="",n.appendChild(r),n.getElementsByClassName("tb_gs_icon")[0].click(),
n.querySelector('[data-action="insert"]').click(),n.classList.add("tb_inline_gs_show"),c.Utils.addViewPortClass(d.contextMenu);!1===u&&(ThemifyConstructor.values=x);d.disable=null;return}}for(u=N.length-1;-1<u;--u){x=N[u].getAttribute("data-cid");let P=c.Models.Registry.lookup(x);var y=P.get("elType"),B="module"===y?P.get("mod_settings"):P.get("styling");if("reset"===r||"gs_r"===r){if("gs_r"===r&&void 0===B[c.GS.key])continue;if(null!==c.activeModel&&c.activeModel.cid===x){var A=ThemifyBuilderCommon.Lightbox.$lightbox.find(".reset-styling")[0];
if(void 0!==A){A.click();continue}}A=t.clone(N[u]);let Z;c.activeModel=P;"reset"===r&&(ThemifyConstructor.component=y,ThemifyConstructor.values=B);let ca="module"===y?"mod_setting":"styling";"visual"===c.mode&&(c.liveStylingInstance.$liveStyledElmt?c.liveStylingInstance.prefix=ThemifyStyles.getBaseSelector("module"===y?c.activeModel.get("mod_name"):y,c.activeModel.get("element_id")):c.liveStylingInstance.init(!0),c.liveStylingInstance.$liveStyledElmt=m(N[u]));y=m.extend(!0,{},B);"reset"===r?(B=ThemifyConstructor.resetStyling(n,
null!==E&&E.cid!==x),"visual"===c.mode&&(Z=m.extend(!0,{},B)),B=m.extend(!0,{},ThemifyConstructor.values)):(delete B[c.GS.key],c.GS.generateValues(null,[],!0));let U={};U[ca]=B;P.set(U,{silent:!0});c.hasChanged=!0;c.undoManager.push(x,A,m(N[u]),"save",{bsettings:y,asettings:B,styles:Z});Z=null}else("delete"!==r&&"visibility"!==r||"column"!==y)&&P.trigger(r,n,n.target,R)}"reset"===r?(c.hasChanged=O,c.activeModel=E,ThemifyConstructor.values=C,ThemifyConstructor.component=G,ThemifyConstructor.beforeData=
K,"visual"===c.mode&&(c.liveStylingInstance.$liveStyledElmt=L,c.liveStylingInstance.prefix=J)):"edit"!==r&&(c.activeModel=null);d.disable=null}"visibility"!==r&&d.hideContextMenu()}}},q=function(n){n.stopPropagation();n.target.classList.contains("tb_inner_action_more")&&(n=n.target.getElementsByTagName("ul")[0])&&c.Utils.addViewPortClass(n)};d.contextMenu=v.getElementById("tb_right_click");null===d.contextMenu&&(d.contextMenu=v.getElementById("tmpl-builder_right_click").content,v.body.appendChild(d.contextMenu),
d.contextMenu=v.getElementById("tb_right_click"),d.contextMenu.addEventListener("click",l),d.contextMenu.addEventListener("mouseover",q,{passive:!0}),d.contextMenu.getElementsByClassName("tb_r_name")[0].addEventListener("mousedown",function(n){1===n.which&&!d.contextMenu.classList.contains("tb_multiply_selected")&&!d.contextMenu.classList.contains("tb_component_column")&&(n.preventDefault(),n.stopPropagation(),n=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_clicked")[0])&&
(d.hideContextMenu(),d.cid=n.dataset.cid,d.moveComponent())}))}var f=!0;!0!==d.isHoverMode&&null!==d.cid?b=c.Instances.Builder[c.builderIndex].el.querySelector('[data-cid="'+d.cid+'"]'):b?f=!1:b=m(a.target).closest("[data-cid]")[0];if(void 0===b)d.contextMenuAnimate=null;else{a.preventDefault();d.hideContextMenu(a.target.classList.contains("tb_bread"));d.disablePosition=!0;v.body.classList.add("tb_right_click_open");d.contextMenu.className="tb_show_context";var e=a.pageX,h=a.pageY,g=c.Models.Registry.lookup(b.dataset.cid),
k=g.get("elType"),p=function(l){if("transform"===l.propertyName){var q=c.Instances.Builder[c.builderIndex].el,n=this.getElementsByClassName("tb_r_name")[0],r=this.getElementsByClassName("tb_action_breadcrumb")[0],u=function(y){y.preventDefault();y.stopPropagation();var B=y.target.getAttribute("data-id");B&&(this.removeEventListener("click",u),d.hideContextMenu(!0),B=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_cid_"+B)[0],void 0!==B&&d.rightClick(y,B))};this.removeEventListener("transitionend",
p,{passive:!0});this.className="tb_component_"+k;"module"===k&&(this.className+=" tb_module_"+g.get("mod_name"));r.innerHTML="";if(!0===a.ctrlKey||!0===a.metaKey)b.classList.add("tb_element_clicked");else if(!b.classList.contains("tb_element_clicked")){l=q.getElementsByClassName("tb_element_clicked");for(let y=l.length-1;-1<y;--y)l[y].classList.remove("tb_element_clicked");b.classList.add("tb_element_clicked")}l=q.getElementsByClassName("tb_element_clicked").length;1<l?(this.className+=" tb_multiply_selected",
n.textContent=themifyBuilder.i18n.multiSelected):(d.breadCrumbsPath.rightClick=d.getBreadCrumbPath(c.Instances.Builder[0].el.getElementsByClassName("tb_element_cid_"+(null===d.breadCrumbsPath.rightClick?g.cid:d.breadCrumbsPath.rightClick[d.breadCrumbsPath.rightClick.length-1]))[0],"rightClick"),r.appendChild(d.getBreadCrumbs(b,"rightClick")),n.textContent="module"===k?themifyBuilder.modules[g.get("mod_name")].name:k);r.addEventListener("click",u);var x=function(y){"transform"===y.propertyName?(this.removeEventListener("transitionend",
x,{passive:!0}),c.Utils.addViewPortClass(this),d.contextMenuAnimate=null):(this.style.top=h+"px",!0===f&&(this.style.left=e+"px"))};this.addEventListener("transitionend",x,{passive:!0});c.undoManager.hasUndo()||(this.className+=" tb_undo_disabled");"column"===k&&(this.className+=" tb_visibility_disabled");c.undoManager.hasRedo()||(this.className+=" tb_redo_disabled");this.className+=" tb_show_context"}};d.contextMenu.addEventListener("transitionend",p,{passive:!0});setTimeout(function(){d.contextMenu.className=
""},18)}}},hideContextMenu(a){null!==this.contextMenu&&(this.contextMenu.style.top="",this.contextMenu.querySelector("#tb_inline_gs").classList.remove("tb_inline_gs_show"),v.body.classList.remove("tb_right_click_open"),this.disablePosition=this.hoverCid=null,!0!==a&&(c.ActionBar.breadCrumbsPath.rightClick=null))},mouseDown(a){1!==a.which||"row"!==this.type&&"subrow"!==this.type||!a.target.classList.contains("tb_move")||(a.preventDefault(),a.stopPropagation(),this.moveComponent())},moveComponent(){var a=
c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_cid_"+this.cid)[0];if(void 0!==a){let b=a.classList.contains("module_row")?a.getElementsByClassName("tb_row_action")[0]:a;a=m(a).offset();let d;this.clear();"function"===typeof Event?d=new Event("mousedown",{bubbles:!0,cancelable:!1}):(d=v.createEvent("Event"),d.initEvent("mousedown",!0,!1));d.pageX=a.left;d.pageY=a.top;d.which=1;b.dispatchEvent(d)}},click(a){if(c.isPreview||!0===this.disable)return!0;var b=a.target,d=b.tagName,
f=null,e=c.Instances.Builder[c.builderIndex].lastRow,h="visual"===c.mode&&b.ownerDocument===w.document?void 0:m(b).closest("[data-cid]")[0],g=a.type;if("click"===g){var k=t.Lightbox.$lightbox[0];this.hideContextMenu();f=!0===a.ctrlKey||!0===a.metaKey;if(w.document.body.classList.contains("tb_standalone_lightbox")&&!w.document.body.classList.contains("modal-open")){c.toolbar.el.contains(b)||k.contains(b)||k.classList.contains("tb_predesigned_lightbox")||k.classList.contains("tb_custom_css_lightbox")||
t.Lightbox.close();var p=w.document.getElementsByClassName("tb_current_menu_selected")[0];void 0!==p&&p.classList.remove("tb_current_menu_selected")}e&&!e.contains(b)&&e.classList.remove("expanded");if(!k.contains(b)&&(!1===f&&this.clearClicked(),void 0!==h)){if(!0===f&&h.classList.contains("tb_element_clicked")){h.classList.remove("tb_element_clicked");return}h.classList.add("tb_element_clicked")}}else if("dblclick"===g&&null!==c.Forms.LayoutPart.id&&b.classList.contains("tb_overlay")){c.Forms.LayoutPart.save(a,
!0);return}e=("click"===g||"dblclick"===g)&&"visual"===c.mode&&t.Lightbox.dockMode.get();if(void 0===h||h.classList.contains("tb_active_layout_part"))"LI"===d&&b.classList.contains("tb_bread")?(a=c.Models.Registry.lookup(b.getAttribute("data-id")),"setting"!==ThemifyConstructor.clicked&&"module"===ThemifyConstructor.component&&(b=t.Lightbox.$lightbox[0].getElementsByClassName("tb_lightbox_top_bar")[0].querySelector(".current a").getAttribute("href"),t.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs").on("themify_opened_lightbox.tb_breadCrumbs",
function(){"row"===ThemifyConstructor.component?t.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs")[0].getElementsByClassName("tb_lightbox_top_bar")[0].querySelector('a[href="'+this+'"]').click():null===c.activeModel&&t.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs")}.bind(b))),this.breadCrumbsPath.lightbox=this.getBreadCrumbPath(c.Instances.Builder[0].el.getElementsByClassName("tb_element_cid_"+(null===this.breadCrumbsPath.lightbox?c.activeModel.cid:this.breadCrumbsPath.lightbox[this.breadCrumbsPath.lightbox.length-
1]))[0]),a.trigger("edit","breadcrumb")):this.el.contains(b)||"click"===a.type&&b.classList.contains("tb_dragger")||this.clear();else{"visual"!==c.mode||"A"!==d&&null===b.closest("a")||a.preventDefault();var l=h.getAttribute("data-cid");k=c.Models.Registry.lookup(l);p=k.get("elType");const q="row"===p&&h.classList.contains("tb-page-break");if(k){if("dblclick"===g){if((!0===e||"INPUT"===d||!0===q||b.classList.contains("tb_dragger_lightbox")||null!==b.closest(".tb_clicked"))&&"tb_row_options"!==b.id)return;
...
const n=!0!==d&&null!==this.cid,r="module"!==p?b.classList.contains("tb_action_wrap"):!0===d;this.cid=l;this.type=p;if(!0===q&&"row"===p)this.clear(),b.classList.contains("tb_row_anchor")&&(a.preventDefault(),a.stopPropagation(),k.trigger("delete",a,b));else if((!1===r||"module"===p&&!0===d)&&null!==b.closest(".tb_action_wrap"))"click"===g&&this.actions(a);else if(!0===d&&"click"===g&&!0===this.needClear)!0===e&&!1===f&&k.trigger("edit",a,b);else if(this.clear(),!0===n&&"click"===g&&!1===f&&!1===
e&&!0===this.needClear){z.body[0].classList.add("tb_action_active");const u=this,x=function(){this.removeEventListener("mousemove",x,{passive:!0,once:!0});null===u.cid&&(z.body[0].classList.remove("tb_action_active"),u.clearClicked())};v.addEventListener("mousemove",x,{passive:!0,once:!0})}else{this.cid=l;this.type=p;g=v.getElementById("tmpl-builder_"+p+"_action").content.cloneNode(!0);if(!0===r){this.prevExpand="module"===p?h.getElementsByClassName("tb_module_action")[0]:b;if(void 0===this.prevExpand){this.clear();
return}this.prevExpand.appendChild(g);this.prevExpand.setAttribute("id",this.el.id);this.prevExpand.closest(".tb_action_wrap").classList.add("tb_clicked");!0===d&&"module"===p&&(f=h.getBoundingClientRect(),g=this.prevExpand.classList,70>f.height||200>f.width?(g.add("tb_small_action_bar"),g.remove("tb_small_action_bar_top","tb_small_action_bar_bottom"),l=this.prevExpand.getBoundingClientRect().top,40>l||40>l-c.Instances.Builder[c.builderIndex].el.getBoundingClientRect().top?g.add("tb_small_action_bar_top"):
g.add("tb_small_action_bar_bottom"),g.toggle("tb_small_action_bar_height",70>f.height),g.toggle("tb_small_action_bar_width",200>f.width)):g.remove("tb_small_action_bar"),"visual"===c.mode&&c.EdgeDrag.addEdges(k.get("mod_name"),k,h))}else("row"!==p||"row"===p&&null!==this.breadCrumbsPath.lightbox)&&this.setBreadCrumbs(h),this.el.className="tb_show_toolbar tb_"+p+"_action",f=v.createElement("div"),f.className="tb_action_label_wrap",f.appendChild(g),"visual"===c.mode&&("module"===p?(g=k.get("mod_name"),
this.el.className+=" tb_"+g+"_action",g=themifyBuilder.modules[g].name):(g=p,"row"===p&&(l=k.get("styling").row_anchor,void 0!==l&&(l=l.trim(),""!==l&&(g+=" #"+l)))),l=v.createElement("div"),l.className="tb_data_mod_name",l.textContent=g.charAt(0).toUpperCase()+g.slice(1),f.appendChild(l)),this.el.appendChild(f);!0!==d&&(h.classList.add("tb_element_clicked"),z.body[0].classList.add("tb_action_active"),"visual"===c.mode&&c.EdgeDrag.addEdges("module"===p?k.get("mod_name"):p,k,h));if(!0===e&&(k.trigger("edit",
a,b),!0===d||null!==this.disablePosition&&!1!==r&&!0===d))return;null===this.disablePosition&&(!1===r&&!0!==d?(b=a.pageX,h=a.pageY,"visual"!==c.mode&&(h=c.Instances.Builder[0].el.getBoundingClientRect(),b=a.clientX-h.left,h=a.clientY-h.top+30),this.setPosition(this.el,{left:b,top:h})):c.Utils.addViewPortClass(this.prevExpand))}}else!0!==isHoverMode&&this.clear()}},setBreadCrumbs(a){for(;null!==this.breadCrumbs.firstChild;)this.breadCrumbs.removeChild(this.breadCrumbs.lastChild);this.breadCrumbs.appendChild(this.getBreadCrumbs(a));
null===this.el.firstChild?this.el.appendChild(this.breadCrumbs):this.el.insertBefore(this.breadCrumbs,this.el.firstChild)},getBreadCrumbPath(a,b){b="rightClick"!==b?"lightbox":b;b=null!==this.breadCrumbsPath[b]?this.breadCrumbsPath[b]:[];if(0<b.length)return b;if(void 0!==a){var d=a.getAttribute("data-cid");for(d&&b.push(d);!a.classList.contains("module_row");)a=a.parentNode,(d=a.getAttribute("data-cid"))&&b.push(d)}return b},getBreadCrumbs(a,b){const d=this.getBreadCrumbPath(a,b),f=v.createDocumentFragment();
if(void 0!==a)for(a="rightClick"===b?a.dataset.cid:c.activeModel?c.activeModel.cid:c.ActionBar.cid,b=d.length-1;-1<b;--b){let e=v.createElement("li"),h=c.Models.Registry.lookup(d[b]),g=h.get("elType");e.textContent="column"===g?h.get("component_name"):"module"===g?h.get("mod_name"):g;e.className="tb_bread tb_bread_"+g;a===d[b]&&(e.className+=" tb_active_bc");e.setAttribute("data-id",d[b]);f.appendChild(e)}return f},actions(a){var b=c.ActionBar,d=a.target,f=d.tagName;if("keydown"===a.type){if("INPUT"!==
f&&"TEXTAREA"!==f&&!themifyBuilder.disableShortcuts&&!t.Lightbox.$lightbox[0].contains(d)&&("visual"!==c.mode||!v.activeElement.contentEditable&&c.liveStylingInstance.$liveStyledElmt[0].contains(v.activeElement))){d=a.keyCode;var e=v.getElementsByClassName("tb_element_clicked");f=e.length;if(0<f){"keydown"!==a.type&&(a.preventDefault(),a.stopPropagation());var h=null,g=null,k=void 0,p=!0===a.ctrlKey||!0===a.metaKey;46===d||8===d?h="delete":!0===p&&(67===d?(h="copy",f=1):68===d?h="duplicate":86===
d&&(h="paste",!0===a.shiftKey&&(g="style")));1<f&&("delete"===h||"paste"===h)&&(k=!0,null!==c.activeModel&&t.Lightbox.$lightbox.is(":visible")&&ThemifyConstructor.saveComponent());for(let q=f-1;-1<q;--q){let n=e[q];if(null===h){if(!0===p&&1===f&&(38===d||40===d)){let r=38===a.which?"up":"down";var l="up"===r?n.previousElementSibling:n.nextElementSibling;if(null!==l){if(n.classList.contains("module_row")){if(!l.classList.contains("module_row"))continue}else if(n.classList.contains("active_module")){if(!l.classList.contains("active_module"))continue;
m(n.parentNode.closest(".tb_holder"))}else continue;l&&(l=m(n),"up"===r?l.prev().before(l):l.next().after(l),!0!==b.isHoverMode&&n.classList.add("tb_element_clicked"))}}}else"delete"===h&&n.classList.contains("module_column")||c.Models.Registry.lookup(m(n).closest("[data-cid]")[0].getAttribute("data-cid")).trigger(h,a,g,k)}"delete"!==h&&!0===b.isHoverMode||b.clear()}}}else if(a.stopPropagation(),"click"===a.type&&null!==d.closest(".switch-wrapper"))d.classList.contains("toggle_switch")&&c.Models.Registry.lookup(m(d).closest("[data-cid]")[0].getAttribute("data-cid")).trigger("visibility",
a,d);else if(a.preventDefault(),null===b.cid||"LI"!==f&&"SPAN"!==f&&"A"!==f)d.parentNode.classList.contains("tb_help")&&d.focus();else if(k=(e=d.classList.contains("tb_bread"))?d.getAttribute("data-id"):b.cid,h=c.Models.Registry.lookup(k),g=d.classList,p=null,h)if(z.body[0].classList.remove("tb_component_menu_active"),!0===e)b.needClear=null,b.disablePosition=!0,v.getElementsByClassName("tb_element_cid_"+k)[0].click(),b.disablePosition=null,"visual"===c.mode&&(a=b.el.getBoundingClientRect(),a.right>=
v.body.clientWidth&&b.setPosition(b.el,{left:a.left,top:b.el.offsetTop+55})),b.needClear=!0;else if(e=d.getAttribute("data-href"),!0===b.isHoverMode&&"tb_row_options"===e&&"click"===a.type)h.trigger("edit",a,d);else if(e)for(a=d.parentNode.getElementsByTagName("li"),d=a.length-1;-1<d;--d)h=(f=a[d].getAttribute("data-href"))?v.getElementById(f):null,g=a[d].classList.contains("selected"),a[d].classList.remove("selected"),null!==h&&h.classList.remove("selected"),f!==e||g||("tb_row_options"===f||"tb_rgrids"===
f?b.gridMenu(h):"tb_roptions"===f&&0===h.children.length&&b.setRowOptions(h),h.classList.add("selected"),a[d].classList.add("selected"),c.Utils.addViewPortClass(h),z.body[0].classList.add("tb_component_menu_active"));else{if(g.contains("tb_edit")||g.contains("tb_styling")||g.contains("tb_visibility_component")||g.contains("tb_swap"))p="edit";else if(g.contains("tb_duplicate"))p="duplicate";else if(g.contains("tb_save_component"))p="save";else if(g.contains("tb_delete"))p="delete";else if(g.contains("tb_import")||
g.contains("tb_export"))p="importExport";else if(g.contains("tb_copy_component"))p="copy";else if(g.contains("tb_paste_component")||g.contains("tb_paste_style"))p="paste";else{if("LI"===f||"SPAN"===f||g.contains("tb_action_more")||g.contains("tb_inner_action_more")){a=d.closest("li");if(null===a)return;h=a.parentNode;e=h.classList;f=e.contains("tb_grid_list")||e.contains("tb_column_alignment")||e.contains("tb_column_gutter")||e.contains("tb_column_direction")||e.contains("tb_column_height")||e.contains("grid_tabs");
d=d.classList.contains("selected");h=h.children;if(f&&d)return;for(g=h.length-1;-1<g;--g)if(h[g].classList.remove("selected"),!1===f)for(k=h[g].getElementsByClassName("selected"),p=k.length-1;-1<p;--p)k[p].classList.remove("selected");d||(a.classList.add("selected"),z.body[0].classList.add("tb_component_menu_active"));if(f)e.contains("tb_column_alignment")?b._columnAlignmentClicked(a):e.contains("tb_column_gutter")?b._gutterChange(a):e.contains("tb_column_direction")?b._columnDirectionClicked(a):
e.contains("tb_column_height")?b._columnHeight(a):e.contains("grid_tabs")?b._switchGridTabs(a):e.contains("tb_grid_list")&&b._gridClicked(a);else{h=null!==b.prevExpand?b.prevExpand.children:b.el.getElementsByClassName("tb_action_label_wrap")[0].children;for(e=h.length-1;-1<e;--e)h[e].classList.remove("selected");d||null!==b.prevExpand&&"column"!==b.type||(b=a.getElementsByTagName("ul")[0],void 0!==b&&c.Utils.addViewPortClass(b))}}return}if(!0!==b.isHoverMode)b.clear();else{let q=d.closest(".tb_action_more");
null!==q&&(q=q.getElementsByTagName("ul")[0],q.style.display="none",setTimeout(function(){null!==q&&(q.style.display="")},100))}h.trigger(p,a,d)}},_switchGridTabs(a){c.ActionBar.disable=c.clearOnModeChange=!0;c.ActionBar.hoverCid=null;c.scrollTo=m(".tb_element_cid_"+this.cid);ThemifyConstructor.lightboxSwitch(a.getAttribute("data-id"));"visual"!==c.mode&&this.gridMenu(a.closest(".tb_toolbar_tabs"))},_gridClicked(a){var b=m(a),d=b.data("grid"),f=this.type;let e;var h=m(".tb_element_cid_"+this.cid).first();
let g=!1;var k=c.activeBreakPoint,p="desktop"===k;a=t.clone(h.closest(".module_row"));g="subrow"===f;e=h.find("."+f+"_inner").first();if(p){k=e;let l=b.data("col");k=k.add(m("#tb_rgrids"));void 0===l&&(l=1,b.data("col",l));for(h=6;0<h;--h)k.removeClass("col-count-"+h);k.addClass("col-count-"+l);e.attr("data-basecol",l);p&&b.closest(".tb_grid_menu").find(".tb_grid_reposnive .tb_grid_list").each(function(){let q=m(this).find(".selected"),n=m(this).data("type"),r=q.data("col");void 0!==r&&(r>l||4===
l&&3===r||4<=l&&4<=r&&l!=r)&&(q.removeClass("selected"),e.removeClass("tb_grid_classes col-count-"+e.attr("data-basecol")+" "+e.attr("data-col_"+n)).attr("data-col_"+n,""),m(this).closest(".tb_grid_list").find("."+n+"-auto").addClass("selected"))})}else return"-auto"!==d[0]?(a="column"+d.join("-"),d=b.data("col"),3===d&&e.attr("data-basecol")>d&&(a+=" tb_3col"),e.removeClass(e.attr("data-col_tablet")+" "+e.attr("data-col_tablet_landscape")+" "+e.attr("data-col_mobile")).addClass(a+" tb_grid_classes col-count-"+
e.attr("data-basecol")).attr("data-col_"+k,a)):e.removeClass("tb_grid_classes tb_3col col-count-"+e.attr("data-basecol")+" "+e.attr("data-col_"+k)).attr("data-col_"+k,""),"visual"===c.mode&&(m("body",w.document).height(v.body.scrollHeight),c.Utils.calculateHeight()),c.Utils.setCompactMode(e.children(".module_column")),!1;b=e.children(".module_column");k=d.length;p="module_column"+(g?" sub_column":"")+" col";for(h=0;h<k;++h)f=b.eq(h),0<f.length?f.removeClass(c.Utils.gridClass.join(" ")).addClass(p+
d[h]):c.Utils._addNewColumn({newclass:p+d[h],component:g?"sub-column":"column"},e[0]);k<e.children().length&&e.children(".module_column").eq(k-1).nextAll().each(function(){m(this).find(".tb_holder").first().children().appendTo(m(this).prev().find(".tb_holder").first());m(this).remove()});d=e.children();d.removeClass("first last");e.hasClass("direction-rtl")?(d.last().addClass("first"),d.first().addClass("last")):(d.first().addClass("first"),d.last().addClass("last"));c.hasChanged=!0;h=e.closest(".module_row");
c.Mixins.Builder.columnDrag(null,b);z.body.triggerHandler("tb_grid_changed",[h,e]);c.undoManager.push(h.data("cid"),a,h,"row")},_columnHeight(a){a=m(a).data("value");if(void 0!==a){var b=m(".tb_element_cid_"+this.cid).first(),d=c.Models.Registry.lookup(this.cid),f=t.clone(b);b=b.find("."+this.type+"_inner").first();""===a?b.removeClass("col_auto_height"):b.addClass("col_auto_height");d.set({column_h:a},{silent:!0});c.undoManager.push(this.cid,f,m(".tb_element_cid_"+this.cid).first(),"row")}},_columnAlignmentClicked(a){a=
m(a);if(a=a.data("alignment")){var b=m(".tb_element_cid_"+this.cid).first(),d=c.Models.Registry.lookup(this.cid),f=t.clone(b);b.find("."+this.type+"_inner").first().removeClass(d.get("column_alignment")).addClass(a);d.set({column_alignment:a},{silent:!0});c.undoManager.push(this.cid,f,m(".tb_element_cid_"+this.cid).first(),"row")}},_columnDirectionClicked(a){a=m(a);if(a=a.data("dir")){var b=m(".tb_element_cid_"+this.cid).first().find("."+this.type+"_inner").first(),d=b.children(".module_column"),
f=d.first();d=d.last();var e=c.Models.Registry.lookup(this.cid),h={};h[c.activeBreakPoint+"_dir"]=a;e.set(h,{silent:!0});"rtl"===a?(f.removeClass("first").addClass("last"),d.removeClass("last").addClass("first"),b.addClass("direction-rtl")):(f.removeClass("last").addClass("first"),d.removeClass("first").addClass("last"),b.removeClass("direction-rtl"));b.attr("data-"+c.activeBreakPoint+"_dir",a)}},_gutterChange(a){if(a=m(a).data("value")){var b=m(".tb_element_cid_"+this.cid).first(),d=c.Models.Registry.lookup(this.cid),
f=d.get("gutter"),e=t.clone(b);b=b.find("."+this.type+"_inner").first();c.Mixins.Builder.columnDrag(null,b[0].children,f,a);b.removeClass(f).addClass(a);d.set({gutter:a},{silent:!0});c.undoManager.push(this.cid,e,m(".tb_element_cid_"+this.cid).first(),"row")}},gridMenu(a){var b=c.activeBreakPoint,d="desktop"===b,f=c.Models.Registry.lookup(this.cid),e=f.get(b+"_dir"),h=f.get("column_alignment");const g=f.get("column_h");f=f.get("gutter");var k=(a.closest(".module_"+this.type)||v.getElementsByClassName("tb_element_cid_"+
this.cid)[0]).getElementsByClassName(this.type+"_inner")[0],p=k.children,l=p.length,q=a.getElementsByClassName("tb_grid_"+b)[0];const n="tb_rgrids"===a.id?a:a.querySelector("#tb_rgrids");a=!0===d?void 0:k.getAttribute("data-col_"+b);k=[];for(let r=0;r<l;++r)k.push(c.Utils._getColClass(p[r].className.split(" ")));for(p=6;-1<p;--p)n.classList.remove("col-count-"+p);n.classList.add("col-count-"+l);k=k.join("-");k="grid-layout-"+("2-1-2-1"===k?"4-2-4-2":k);p=q.getElementsByClassName("tb_grid_list")[0].getElementsByTagName("li");
a="-auto"!==a&&a?"grid-layout-"+a.replace(/column|tb_3col/ig,"").trim():!1;!1!==d||!1!==a&&1!==l||(a=b+"-auto");for(b=p.length-1;-1<b;--b)l=!0===d&&p[b].classList.contains(k)||!1===d&&p[b].classList.contains(a),p[b].classList.toggle("selected",l);if("ltr"!==e)for(p=q.getElementsByClassName("tb_column_direction")[0].getElementsByTagName("li"),b=p.length-1;-1<b;--b)p[b].classList.toggle("selected",p[b].getAttribute("data-dir")===e);if(!0===d){if("col_align_top"!==h||!0===ba)for(d=q.getElementsByClassName("tb_column_alignment")[0].getElementsByTagName("li"),
e=d.length-1;-1<e;--e)d[e].classList.toggle("selected",d[e].getAttribute("data-alignment")===h);if("gutter-default"!==f)for(h=q.getElementsByClassName("tb_column_gutter")[0].getElementsByTagName("li"),d=h.length-1;-1<d;--d)h[d].classList.toggle("selected",h[d].getAttribute("data-value")===f);if(g)for(f=q.getElementsByClassName("tb_column_height")[0].getElementsByTagName("li"),q=f.length-1;-1<q;--q)f[q].classList.toggle("selected",f[q].getAttribute("data-value")==g)}},setRowOptions(a){var b=null;const d=
c.activeModel,f=ThemifyConstructor.component,e=c.Models.Registry.lookup(this.cid),h=e.get("styling")||{};null!==d&&(b="module"===c.activeModel.get("elType")?"mod_settings":"styling",b=c.activeModel.get(b));if(void 0!==a.children[0])for(;a.firstChild;)a.removeChild(a.lastChild);ThemifyConstructor.values=h;ThemifyConstructor.component=this.type;c.activeModel=e;a.appendChild(ThemifyConstructor.create(ThemifyConstructor.data.row.setting.options.slice(0,6)));ThemifyConstructor.values=b;c.activeModel=d;
ThemifyConstructor.component=f},clear(){if(null!==this.type){this.cid=this.type=null;for(this.el.classList.remove("tb_show_toolbar");null!==this.el.firstChild;)this.el.removeChild(this.el.lastChild);if(null!==this.prevExpand&&void 0!==this.prevExpand){for(;null!==this.prevExpand.firstChild;)this.prevExpand.removeChild(this.prevExpand.lastChild);this.prevExpand.removeAttribute("id");"visual"===c.mode&&(this.prevExpand.style.top="");this.prevExpand.closest(".tb_action_wrap").classList.remove("tb_clicked");
...
loadingPosts:!1,allLoaded:!1,el:null,dropdown:null,isShown:null,field:null,isGSPage:v.body.classList.contains("gs_post"),activeGS:null,xhr:null,key:"global_styles",previousModel:null,liveInstance:null,init(){if(!0===this.isGSPage)if(w.document.body.classList.add("gs_post"),"visual"!==c.mode||!0===z.is_builder_loaded)this.openStylingPanel();else{const a=this;w.Themify.body.one("themify_builder_ready",function(b){a.openStylingPanel()})}else null!==themifyBuilder.globalStyles&&(this.extend(this.styles,
...
findUsedItems(a){a=JSON.stringify(a);var b=/"global_styles":"(.*?)"/mg;let d,f="";for(;null!==(d=b.exec(a));)f+=" "+d[1].trim();f=f.trim();if(""!==f){f=m.unique(f.split(" "));a=[];for(b=f.length-1;-1<b;--b)void 0!==this.styles[f[b]]&&a.push(f[b]);return a}return!1},globalStylesHTML(){if(!0===this.isGSPage||null!==this.activeGS)return!1;const a=v.createElement("div");var b=v.createElement("div");const d=v.createElement("span");this.isShown=null;this.field=ThemifyConstructor.hidden.render({id:c.GS.key,
...
"":"none")}};null!==a.xhr&&(a.xhr.abort(),a.xhr=null);a.allLoaded||setTimeout(function(){a.loadMore(d,e)},100);e()}.bind(this),{passive:!0})},addItemToDropdown(a){if(null!==this.dropdown){var b=v.createDocumentFragment(),d=this.field.value.split(" "),f=this.dropdown.getElementsByClassName("tb_no_gs_item")[0];for(let e=0,h=a.length;e<h;++e){let g=this.styles[a[e]],k=v.createElement("div"),p=v.createElement("span"),l=v.createElement("span");k.className="global_style_item";k.className+=-1!==d.indexOf(a[e])?
...
e));if(-1!==n.indexOf("tb_row_frame",e))for(let r in k)if(!1===k[r]&&-1!==n.indexOf("tb_row_frame_"+r,e)){k[r]=!0;++p;break}if(!0===g&&4===p)break a}!1===h&&!0===g&&f.addOrRemoveComponentOverlay();if(0<p){a=v.createDocumentFragment();for(var q in k)!0===k[q]&&0===d.children(".tb_row_frame_"+q).length&&(l=v.createElement("div"),l.className="tf_abs tb_row_frame tb_row_frame_"+q,a.appendChild(l));d.children(".tb_action_wrap").after(a)}(q=void 0!==b.styling?b.styling.background_type:"none")||(q="image");
"image"===q&&"builder-parallax-scrolling"===b.styling.background_repeat&&b.styling.background_image?(d[0].classList.add("builder-parallax-scrolling"),ThemifyBuilderModuleJs.backgroundScrolling(d)):(d[0].classList.remove("builder-parallax-scrolling"),d[0].style.backgroundPosition="","image"===q&&"builder-zoom-scrolling"===b.styling.background_repeat&&b.styling.background_image?(d[0].classList.add("builder-zoom-scrolling"),ThemifyBuilderModuleJs.backgroundZoom(d)):(d[0].classList.remove("builder-zoom-scrolling"),
d[0].style.backgroundSize=""))},liveEdit(a){let b={styleClicked:!0},d,f=!1;if(null===c.activeModel&&null!==c.ActionBar.contextMenu&&c.ActionBar.contextMenu.contains(this.field)){var e=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_clicked")[0];if(void 0===e)return;c.activeModel=c.Models.Registry.lookup(e.getAttribute("data-cid"));b.element_id=c.activeModel.get("element_id");this.previousModel=c.activeModel.cid;f=!0;c.Utils.scrollToDropped(e)}else null!==c.activeModel&&(this.previousModel=
c.activeModel.cid,b.element_id=c.activeModel.get("element_id"),ThemifyConstructor.saveComponent(!0));const h=this.styles[a],g=this,k=ThemifyConstructor.label.done,p="visual"===c.mode?m.extend(!0,{},c.liveStylingInstance):null;e=m.extend(!0,{},h.data[0]);const l=h.type;this.activeGS=a;"row"===l?(delete e.cols,delete e.styling[this.key],d=c.Views.init_row(e)):"subrow"===l?(delete e.cols,delete e.styling[this.key],d=c.Views.init_subrow(e)):(delete e.styling,"column"===l?(delete e.cols[0].modules,delete e.cols[0].styling[this.key],
d=c.Views.init_column(e.cols[0])):(delete e.cols[0].styling,delete e.cols[0].modules[0].mod_settings[this.key],d=c.Views.init_module(e.cols[0].modules[0])));t.Lightbox.$lightbox[0].className+=" gs_post";ThemifyConstructor.label.done=ThemifyConstructor.label.s_s;c.ActionBar.hideContextMenu();t.Lightbox.$lightbox.one("themify_opened_lightbox.tb_gs_edit",function(){this.getElementsByClassName("current")[0].getElementsByClassName("tb_tooltip")[0].textContent=ThemifyConstructor.label.g_s+" - "+h.title});
d.model.set(b,{silent:!0});d.model.trigger("edit",null);const q=function(){z.body.off("themify_builder_lightbox_close.tb_gs_edit themify_builder_save_component.tb_gs_edit");t.Lightbox.$lightbox[0].classList.remove("gs_post");ThemifyConstructor.label.done=k;d.model.destroy();if("visual"===c.mode){if(p.prefix&&(c.liveStylingInstance=p,c.liveStylingInstance.$liveStyledElmt=m(v.querySelector(p.prefix)),null!==g.previousModel&&("row"===l||"column"===l||"subrow"===l))){const n=c.Models.Registry.lookup(g.previousModel);
n&&"module"===n.get("elType")&&(c.liveStylingInstance.getComponentBgOverlay().remove(),c.liveStylingInstance.removeBgSlider(),c.liveStylingInstance.removeBgVideo(),c.liveStylingInstance.$liveStyledElmt.children(".tb_row_frame").remove(),c.liveStylingInstance.$liveStyledElmt[0].classList.remove("builder-zoom-scrolling","builder-zooming"))}g.liveInstance=null}g.activeGS=null};z.body.one("themify_builder_lightbox_close.tb_gs_edit",function(n){q();f?g.previousModel=null:g.reopenPreviousPanel()}).one("themify_builder_save_component.tb_gs_edit",
function(n,r){n=g.activeGS;const u=g.styles[n],x=g.previousModel;delete ThemifyConstructor.values.cid;ThemifyConstructor.setStylingValues(c.activeBreakPoint);var y=ThemifyConstructor.values;const B=c.activeModel;delete y[this.key];"row"===l||"subrow"===l?(u.data[0].styling=y,delete u.data[0].cols):(delete u.data[0].styling,delete u.data[0].cols[0].grid_class,"column"===l?(delete u.data[0].cols[0].modules,u.data[0].cols[0].styling=y):(delete u.data[0].cols[0].styling,u.data[0].cols[0].modules[0].mod_settings=
y));t.showLoader("show");c.Utils.saveCss(u.data,"",u.id);u.data=c.Utils.clear(u.data);g.styles[n].data=u.data;g.activeGS=null;g.previousModel=null;if("visual"===c.mode&&c.hasChanged){y=c.Models.Registry.items;for(let A in y){let E="module"===y[A].get("elType")?y[A].get("mod_settings"):y[A].get("styling");void 0!==E[g.key]&&""!==E[g.key]&&-1!==E[g.key].indexOf(n)&&(c.activeModel=y[A],g.generateValues(n,E[g.key].split(" "),!0))}g.liveInstance=null}c.activeModel=B;g.previousModel=x;q(!0);c.hasChanged=
!1;m.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_update_global_style",tb_load_nonce:themifyBuilder.tb_load_nonce,data:u.data,id:u.id},error(){t.showLoader("error")},success(){r||f?g.previousModel=null:g.reopenPreviousPanel();t.showLoader("hide")}})})},reopenPreviousPanel(a){void 0!==a?a.model.trigger("edit",a.e,a.target):null!==this.previousModel&&(a=c.Models.Registry.lookup(this.previousModel),null!==a&&(a.set({styleClicked:!0},{silent:!0}),a.trigger("edit",null)),
this.previousModel=null)},stylingOverlay(){if(null===this.isShown&&null!==c.activeModel&&(null===this.el.parentNode||!this.el.parentNode.classList.contains("tb_inline_gs_show"))){this.isShown=!0;const a=v.createElement("div"),b=v.createElement("p");a.className="tb_gs_options_overlay";b.textContent=themifyBuilder.i18n.has_gs;a.addEventListener("click",function(d){d.preventDefault();d.stopPropagation();this.parentNode.removeChild(this)},{once:!0});a.appendChild(b);return a}return null}}})(jQuery,Backbone,
